...
class TenantHardwareSpec(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["instanceSize", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instanceSize", ], str]):
