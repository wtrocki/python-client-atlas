...
class TokenFilterlength(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "max", "min", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "max", "min", ], str]):
