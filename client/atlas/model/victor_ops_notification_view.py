...
class VictorOpsNotificationView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class intervalMin(
                ...
                class MetaOapg:
                    format = 'int32'
                    inclusive_minimum = 5
            victorOpsApiKey = schemas.StrSchema
            victorOpsRoutingKey = schemas.StrSchema
            __annotations__ = {
                "typeName": typeName,
                "delayMin": delayMin,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["victorOpsApiKey"]) -> MetaOapg.properties.victorOpsApiKey: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["victorOpsRoutingKey"]) -> MetaOapg.properties.victorOpsRoutingKey: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "intervalMin", "victorOpsApiKey", "victorOpsRoutingKey", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["victorOpsApiKey"]) -> typing.Union[MetaOapg.properties.victorOpsApiKey, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["victorOpsRoutingKey"]) -> typing.Union[MetaOapg.properties.victorOpsRoutingKey, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "intervalMin", "victorOpsApiKey", "victorOpsRoutingKey", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        victorOpsApiKey: typing.Union[MetaOapg.properties.victorOpsApiKey, str, schemas.Unset] = schemas.unset,
        victorOpsRoutingKey: typing.Union[MetaOapg.properties.victorOpsRoutingKey, str, schemas.Unset] = schemas.unset,
