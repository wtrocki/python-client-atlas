...
class SMSNotificationView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "intervalMin", "mobileNumber", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "intervalMin", "mobileNumber", ], str]):
