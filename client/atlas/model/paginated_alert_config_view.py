...
class PaginatedAlertConfigView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AlertConfigViewForNdsGroup']:
                        return AlertConfigViewForNdsGroup
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AlertConfigViewForNdsGroup'], typing.List['AlertConfigViewForNdsGroup']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AlertConfigViewForNdsGroup':
                    return super().__getitem__(i)
