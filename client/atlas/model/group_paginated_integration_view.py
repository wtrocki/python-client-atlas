...
class GroupPaginatedIntegrationView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IntegrationViewForNdsGroup']:
                        return IntegrationViewForNdsGroup
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IntegrationViewForNdsGroup'], typing.List['IntegrationViewForNdsGroup']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'IntegrationViewForNdsGroup':
                    return super().__getitem__(i)
