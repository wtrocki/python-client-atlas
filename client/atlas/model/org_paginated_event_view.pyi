        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EventViewForOrg']:
                        return EventViewForOrg
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EventViewForOrg'], typing.List['EventViewForOrg']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'EventViewForOrg':
                    return super().__getitem__(i)
