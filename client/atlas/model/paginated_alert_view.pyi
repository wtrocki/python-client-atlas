        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AlertViewForNdsGroup']:
                        return AlertViewForNdsGroup
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AlertViewForNdsGroup'], typing.List['AlertViewForNdsGroup']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AlertViewForNdsGroup':
                    return super().__getitem__(i)
