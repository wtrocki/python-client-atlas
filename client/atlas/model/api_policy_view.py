...
class ApiPolicyView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "policyItems", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "policyItems", ], str]):
