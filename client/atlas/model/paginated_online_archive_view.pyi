...
class PaginatedOnlineArchiveView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OnlineArchive']:
                        return OnlineArchive
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OnlineArchive'], typing.List['OnlineArchive']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'OnlineArchive':
                    return super().__getitem__(i)
