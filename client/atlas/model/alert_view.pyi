...
class AlertView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "groupId", "lastNotified", "links", "orgId", "resolved", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "groupId", "lastNotified", "links", "orgId", "resolved", ], str]):
