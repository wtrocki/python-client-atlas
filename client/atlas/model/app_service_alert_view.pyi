...
class AppServiceAlertView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['AppServiceEventTypeViewAlertable']:
                return AppServiceEventTypeViewAlertable
    ...
    eventTypeName: 'AppServiceEventTypeViewAlertable'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'AppServiceEventTypeViewAlertable': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'AppServiceEventTypeViewAlertable': ...
