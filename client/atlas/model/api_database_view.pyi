...
class ApiDatabaseView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["databaseName", "links", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["databaseName", "links", ], str]):
