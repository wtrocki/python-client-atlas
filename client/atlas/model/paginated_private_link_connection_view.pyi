...
class PaginatedPrivateLinkConnectionView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EndpointService']:
                        return EndpointService
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EndpointService'], typing.List['EndpointService']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'EndpointService':
                    return super().__getitem__(i)
