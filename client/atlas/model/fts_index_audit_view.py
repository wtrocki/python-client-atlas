...
class FTSIndexAuditView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['FTSIndexAuditTypeView']:
                return FTSIndexAuditTypeView
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'FTSIndexAuditTypeView': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'FTSIndexAuditTypeView': ...
