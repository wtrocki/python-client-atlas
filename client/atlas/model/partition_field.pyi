...
class PartitionField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fieldName", "order", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fieldName", "order", ], str]):
