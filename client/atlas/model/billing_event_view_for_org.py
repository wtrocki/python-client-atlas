...
class BillingEventViewForOrg(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['BillingEventTypeViewForOrg']:
                return BillingEventTypeViewForOrg
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'BillingEventTypeViewForOrg': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'BillingEventTypeViewForOrg': ...
