...
class PaginatedTenantRestoreView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TenantRestore']:
                        return TenantRestore
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TenantRestore'], typing.List['TenantRestore']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TenantRestore':
                    return super().__getitem__(i)
