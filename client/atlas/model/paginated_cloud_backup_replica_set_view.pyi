...
class PaginatedCloudBackupReplicaSetView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DiskBackupReplicaSet']:
                        return DiskBackupReplicaSet
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DiskBackupReplicaSet'], typing.List['DiskBackupReplicaSet']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DiskBackupReplicaSet':
                    return super().__getitem__(i)
