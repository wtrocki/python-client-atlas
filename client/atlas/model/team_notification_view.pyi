...
class TeamNotificationView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "emailEnabled", "intervalMin", "smsEnabled", "teamId", "teamName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "emailEnabled", "intervalMin", "smsEnabled", "teamId", "teamName", ], str]):
