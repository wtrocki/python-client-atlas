...
class DataExplorerAccessedEventView(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['DataExplorerAccessedEventTypeView']:
                return DataExplorerAccessedEventTypeView
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'DataExplorerAccessedEventTypeView': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "apiKeyId", "collection", "database", "groupId", "isGlobalAdmin", "links", "opType", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'DataExplorerAccessedEventTypeView': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "apiKeyId", "collection", "database", "groupId", "isGlobalAdmin", "links", "opType", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username", ], str]):
