        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['GCPPeerVpc']:
                        return GCPPeerVpc
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['GCPPeerVpc'], typing.List['GCPPeerVpc']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'GCPPeerVpc':
                    return super().__getitem__(i)
