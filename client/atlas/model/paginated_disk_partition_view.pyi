...
class PaginatedDiskPartitionView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiDiskPartitionView']:
                        return ApiDiskPartitionView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiDiskPartitionView'], typing.List['ApiDiskPartitionView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiDiskPartitionView':
                    return super().__getitem__(i)
