...
class ApiNamespaceObjView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["namespace", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["namespace", "type", ], str]):
