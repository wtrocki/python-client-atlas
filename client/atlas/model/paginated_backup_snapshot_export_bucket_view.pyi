...
class PaginatedBackupSnapshotExportBucketView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DiskBackupSnapshotAWSExportBucket']:
                        return DiskBackupSnapshotAWSExportBucket
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DiskBackupSnapshotAWSExportBucket'], typing.List['DiskBackupSnapshotAWSExportBucket']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DiskBackupSnapshotAWSExportBucket':
                    return super().__getitem__(i)
