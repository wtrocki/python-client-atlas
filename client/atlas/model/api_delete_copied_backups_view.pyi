...
class ApiDeleteCopiedBackupsView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cloudProvider", "regionName", "replicationSpecId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cloudProvider", "regionName", "replicationSpecId", ], str]):
