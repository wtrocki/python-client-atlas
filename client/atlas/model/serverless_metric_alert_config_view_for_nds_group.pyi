...
class ServerlessMetricAlertConfigViewForNdsGroup(
    schemas.DictSchema
):
    ...
    eventTypeName: 'ServerlessEventTypeViewAlertable'
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'ServerlessEventTypeViewAlertable': ...
