...
class UserEventViewForNdsGroup(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "apiKeyId", "groupId", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "targetUsername", "userId", "username", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'UserEventTypeViewForNdsGroup': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "apiKeyId", "groupId", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "targetUsername", "userId", "username", ], str]):
