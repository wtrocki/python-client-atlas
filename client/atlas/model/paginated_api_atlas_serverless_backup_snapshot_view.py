...
class PaginatedApiAtlasServerlessBackupSnapshotView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ServerlessBackupSnapshot']:
                        return ServerlessBackupSnapshot
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ServerlessBackupSnapshot'], typing.List['ServerlessBackupSnapshot']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ServerlessBackupSnapshot':
                    return super().__getitem__(i)
