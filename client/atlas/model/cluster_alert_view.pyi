...
class ClusterAlertView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "eventTypeName", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "clusterName", "groupId", "lastNotified", "links", "orgId", "resolved", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "eventTypeName", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "clusterName", "groupId", "lastNotified", "links", "orgId", "resolved", ], str]):
