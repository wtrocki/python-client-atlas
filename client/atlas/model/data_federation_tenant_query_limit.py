...
class DataFederationTenantQueryLimit(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "value", "currentUsage", "defaultLimit", "lastModifiedDate", "maximumLimit", "overrunPolicy", "tenantName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "value", "currentUsage", "defaultLimit", "lastModifiedDate", "maximumLimit", "overrunPolicy", "tenantName", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tenantName: typing.Union[MetaOapg.properties.tenantName, str, schemas.Unset] = schemas.unset,
