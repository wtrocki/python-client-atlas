...
class NDSNotificationView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "intervalMin", "severity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "intervalMin", "severity", ], str]):
