...
class HostEventViewForNdsGroup(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['HostEventTypeViewForNdsGroup']:
                return HostEventTypeViewForNdsGroup
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'HostEventTypeViewForNdsGroup': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "apiKeyId", "groupId", "isGlobalAdmin", "links", "orgId", "port", "publicKey", "raw", "remoteAddress", "replicaSetName", "shardName", "userId", "username", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'HostEventTypeViewForNdsGroup': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "apiKeyId", "groupId", "isGlobalAdmin", "links", "orgId", "port", "publicKey", "raw", "remoteAddress", "replicaSetName", "shardName", "userId", "username", ], str]):
