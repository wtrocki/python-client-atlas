...
class PaginatedPipelineRunView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IngestionPipelineRun']:
                        return IngestionPipelineRun
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['IngestionPipelineRun'], typing.List['IngestionPipelineRun']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'IngestionPipelineRun':
                    return super().__getitem__(i)
