...
class ExampleResourceResponseView20230201(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "additionalInfo", "data", "links", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "additionalInfo", "data", "links", ], str]):
