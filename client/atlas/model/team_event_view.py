...
class TeamEventView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['TeamEventTypeView']:
                return TeamEventTypeView
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'TeamEventTypeView': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'TeamEventTypeView': ...
