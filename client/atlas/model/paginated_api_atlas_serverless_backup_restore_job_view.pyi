...
class PaginatedApiAtlasServerlessBackupRestoreJobView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ServerlessBackupRestoreJob']:
                        return ServerlessBackupRestoreJob
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ServerlessBackupRestoreJob'], typing.List['ServerlessBackupRestoreJob']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ServerlessBackupRestoreJob':
                    return super().__getitem__(i)
