...
class X509Certificate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "notAfter", "notBefore", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "notAfter", "notBefore", ], str]):
