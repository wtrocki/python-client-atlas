...
class CustomDBRole(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["roleName", "actions", "inheritedRoles", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["roleName", "actions", "inheritedRoles", ], str]):
