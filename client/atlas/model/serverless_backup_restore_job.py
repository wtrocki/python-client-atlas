...
class ServerlessBackupRestoreJob(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["deliveryType", "targetClusterName", "targetGroupId", "cancelled", "deliveryUrl", "desiredTimestamp", "expired", "expiresAt", "failed", "finishedAt", "id", "links", "oplogInc", "oplogTs", "pointInTimeUTCSeconds", "snapshotId", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["deliveryType", "targetClusterName", "targetGroupId", "cancelled", "deliveryUrl", "desiredTimestamp", "expired", "expiresAt", "failed", "finishedAt", "id", "links", "oplogInc", "oplogTs", "pointInTimeUTCSeconds", "snapshotId", "timestamp", ], str]):
