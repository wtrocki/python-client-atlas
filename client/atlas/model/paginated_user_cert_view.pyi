        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UserCert']:
                        return UserCert
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['UserCert'], typing.List['UserCert']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'UserCert':
                    return super().__getitem__(i)
