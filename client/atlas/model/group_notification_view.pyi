...
class GroupNotificationView(
            ...
            class roles(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        @schemas.classproperty
                        def GROUP_READ_WRITE(cls):
                            return cls("GROUP_READ_WRITE")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "emailEnabled", "intervalMin", "roles", "smsEnabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeName", "delayMin", "emailEnabled", "intervalMin", "roles", "smsEnabled", ], str]):
