...
class ReplicaSetThresholdAlertConfigViewForNdsGroup(
        ...
        def discriminator():
            return {
                'eventTypeName': {
                    ...
                    'REPLICATION_OPLOG_WINDOW_RUNNING_OUT': LessThanTimeThresholdAlertConfigViewForNdsGroup,
                    'TOO_MANY_ELECTIONS': GreaterThanRawThresholdAlertConfigViewForNdsGroup,
                }
            }
