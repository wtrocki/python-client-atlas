...
class ApiUserEventViewForNdsGroup(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['ApiUserEventTypeViewForNdsGroup']:
                return ApiUserEventTypeViewForNdsGroup
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'ApiUserEventTypeViewForNdsGroup': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'ApiUserEventTypeViewForNdsGroup': ...
