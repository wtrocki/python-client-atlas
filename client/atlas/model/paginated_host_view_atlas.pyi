        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiHostViewAtlas']:
                        return ApiHostViewAtlas
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiHostViewAtlas'], typing.List['ApiHostViewAtlas']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiHostViewAtlas':
                    return super().__getitem__(i)
