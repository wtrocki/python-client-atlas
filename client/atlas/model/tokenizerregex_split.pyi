...
class TokenizerregexSplit(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pattern", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pattern", "type", ], str]):
