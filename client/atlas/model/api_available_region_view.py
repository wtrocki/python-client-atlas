...
class ApiAvailableRegionView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["default", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["default", "name", ], str]):
