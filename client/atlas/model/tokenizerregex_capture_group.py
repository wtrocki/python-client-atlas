...
class TokenizerregexCaptureGroup(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def REGEX_CAPTURE_GROUP(cls):
                    return cls("regexCaptureGroup")
            __annotations__ = {
                "group": group,
                "pattern": pattern,
                "type": type,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["group", "pattern", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["group", "pattern", "type", ], str]):
