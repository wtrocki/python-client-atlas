        ...
        class properties:
            ...
            class dataPoints(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiMetricDataPointViewAtlas']:
                        return ApiMetricDataPointViewAtlas
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiMetricDataPointViewAtlas'], typing.List['ApiMetricDataPointViewAtlas']],
                ...
                def __getitem__(self, i: int) -> 'ApiMetricDataPointViewAtlas':
