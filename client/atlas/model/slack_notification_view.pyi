...
class SlackNotificationView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["typeName", "apiToken", "channelName", "delayMin", "intervalMin", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["typeName", "apiToken", "channelName", "delayMin", "intervalMin", ], str]):
