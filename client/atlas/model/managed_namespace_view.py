...
class ManagedNamespaceView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            numInitialChunks = schemas.Int64Schema
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["customShardKey"]) -> typing.Union[MetaOapg.properties.customShardKey, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        customShardKey: typing.Union[MetaOapg.properties.customShardKey, str, schemas.Unset] = schemas.unset,
