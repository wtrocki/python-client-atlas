...
class PaginatedApiAtlasProviderRegionsView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProviderRegions']:
                        return ProviderRegions
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ProviderRegions'], typing.List['ProviderRegions']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ProviderRegions':
                    return super().__getitem__(i)
