...
class PaginatedCloudProviderContainerView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CloudProviderContainer']:
                        return CloudProviderContainer
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['CloudProviderContainer'], typing.List['CloudProviderContainer']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CloudProviderContainer':
                    return super().__getitem__(i)
