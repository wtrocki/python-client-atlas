...
class PaginatedTenantSnapshotView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TenantSnapshot']:
                        return TenantSnapshot
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TenantSnapshot'], typing.List['TenantSnapshot']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TenantSnapshot':
                    return super().__getitem__(i)
