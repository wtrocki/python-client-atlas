        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiAppUserView']:
                        return ApiAppUserView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiAppUserView'], typing.List['ApiAppUserView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiAppUserView':
                    return super().__getitem__(i)
