...
class X509CertificateView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["notAfter", "notBefore", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["notAfter", "notBefore", ], str]):
