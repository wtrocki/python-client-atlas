...
class ZoneMapping(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["location", "zone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["location", "zone", ], str]):
