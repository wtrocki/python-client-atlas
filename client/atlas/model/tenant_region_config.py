...
class TenantRegionConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["backingProviderName", "electableSpecs", "priority", "providerName", "regionName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["backingProviderName", "electableSpecs", "priority", "providerName", "regionName", ], str]):
