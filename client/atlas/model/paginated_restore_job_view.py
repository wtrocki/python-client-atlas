        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiRestoreJobView']:
                        return ApiRestoreJobView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiRestoreJobView'], typing.List['ApiRestoreJobView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiRestoreJobView':
                    return super().__getitem__(i)
