...
class PaginatedAzurePeerNetworkView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AzurePeerNetwork']:
                        return AzurePeerNetwork
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AzurePeerNetwork'], typing.List['AzurePeerNetwork']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AzurePeerNetwork':
                    return super().__getitem__(i)
