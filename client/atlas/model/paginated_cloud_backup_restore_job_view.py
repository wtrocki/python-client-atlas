...
class PaginatedCloudBackupRestoreJobView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DiskBackupRestoreJob']:
                        return DiskBackupRestoreJob
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DiskBackupRestoreJob'], typing.List['DiskBackupRestoreJob']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DiskBackupRestoreJob':
                    return super().__getitem__(i)
