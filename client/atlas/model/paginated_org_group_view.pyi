        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrgGroupView']:
                        return OrgGroupView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OrgGroupView'], typing.List['OrgGroupView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'OrgGroupView':
                    return super().__getitem__(i)
