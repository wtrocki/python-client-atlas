...
class InheritedRole(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["db", "role", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["db", "role", ], str]):
