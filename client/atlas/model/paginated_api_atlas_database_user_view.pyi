...
class PaginatedApiAtlasDatabaseUserView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DatabaseUser']:
                        return DatabaseUser
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DatabaseUser'], typing.List['DatabaseUser']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DatabaseUser':
                    return super().__getitem__(i)
