        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AWSPeerVpc']:
                        return AWSPeerVpc
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AWSPeerVpc'], typing.List['AWSPeerVpc']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AWSPeerVpc':
                    return super().__getitem__(i)
