        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiTeamResponseView']:
                        return ApiTeamResponseView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiTeamResponseView'], typing.List['ApiTeamResponseView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiTeamResponseView':
                    return super().__getitem__(i)
