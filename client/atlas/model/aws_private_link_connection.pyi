...
class AWSPrivateLinkConnection(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interfaceEndpoints"]) -> MetaOapg.properties.interfaceEndpoints: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endpointServiceName", "errorMessage", "id", "interfaceEndpoints", "regionName", "status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interfaceEndpoints"]) -> typing.Union[MetaOapg.properties.interfaceEndpoints, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endpointServiceName", "errorMessage", "id", "interfaceEndpoints", "regionName", "status", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        interfaceEndpoints: typing.Union[MetaOapg.properties.interfaceEndpoints, list, tuple, schemas.Unset] = schemas.unset,
