...
class DataLakeDataProcessRegion(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def region() -> typing.Type['DataLakeRegion']:
                return DataLakeRegion
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["region"]) -> 'DataLakeRegion': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cloudProvider", "region", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["region"]) -> 'DataLakeRegion': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cloudProvider", "region", ], str]):
