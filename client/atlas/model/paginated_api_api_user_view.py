        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiApiUserView']:
                        return ApiApiUserView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiApiUserView'], typing.List['ApiApiUserView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiApiUserView':
                    return super().__getitem__(i)
