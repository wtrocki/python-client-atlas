...
class PaginatedClusterDescriptionV15View(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ClusterDescriptionV15']:
                        return ClusterDescriptionV15
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ClusterDescriptionV15'], typing.List['ClusterDescriptionV15']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ClusterDescriptionV15':
                    return super().__getitem__(i)
