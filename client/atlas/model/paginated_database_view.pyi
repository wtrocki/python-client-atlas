        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiDatabaseView']:
                        return ApiDatabaseView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiDatabaseView'], typing.List['ApiDatabaseView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiDatabaseView':
                    return super().__getitem__(i)
