...
class PaginatedBackupSnapshotView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DiskBackupSnapshot']:
                        return DiskBackupSnapshot
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DiskBackupSnapshot'], typing.List['DiskBackupSnapshot']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DiskBackupSnapshot':
                    return super().__getitem__(i)
