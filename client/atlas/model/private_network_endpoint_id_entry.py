...
class PrivateNetworkEndpointIdEntry(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endpointId", "comment", "provider", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endpointId", "comment", "provider", "type", ], str]):
