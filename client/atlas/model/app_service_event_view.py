...
class AppServiceEventView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['AppServiceEventTypeView']:
                return AppServiceEventTypeView
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'AppServiceEventTypeView': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "groupId", "links", "orgId", "raw", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'AppServiceEventTypeView': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created", "eventTypeName", "id", "groupId", "links", "orgId", "raw", ], str]):
