...
class PaginatedServerlessInstanceDescriptionView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ServerlessInstanceDescription']:
                        return ServerlessInstanceDescription
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ServerlessInstanceDescription'], typing.List['ServerlessInstanceDescription']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ServerlessInstanceDescription':
                    return super().__getitem__(i)
