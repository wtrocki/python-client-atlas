...
class HostAlertViewForNdsGroup(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def eventTypeName() -> typing.Type['HostEventTypeViewForNdsGroupAlertable']:
                return HostEventTypeViewForNdsGroupAlertable
    ...
    eventTypeName: 'HostEventTypeViewForNdsGroupAlertable'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eventTypeName"]) -> 'HostEventTypeViewForNdsGroupAlertable': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "eventTypeName", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "clusterName", "groupId", "hostnameAndPort", "lastNotified", "links", "orgId", "replicaSetName", "resolved", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'HostEventTypeViewForNdsGroupAlertable': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "eventTypeName", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "clusterName", "groupId", "hostnameAndPort", "lastNotified", "links", "orgId", "replicaSetName", "resolved", ], str]):
