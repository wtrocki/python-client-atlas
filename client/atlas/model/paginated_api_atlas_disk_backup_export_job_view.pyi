...
class PaginatedApiAtlasDiskBackupExportJobView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DiskBackupExportJob']:
                        return DiskBackupExportJob
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DiskBackupExportJob'], typing.List['DiskBackupExportJob']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DiskBackupExportJob':
                    return super().__getitem__(i)
