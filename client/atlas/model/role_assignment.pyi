...
class RoleAssignment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["groupId", "orgId", "role", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["groupId", "orgId", "role", ], str]):
