...
class CustomCriteriaView(
    ...
    **CUSTOM criteria.type**.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["query", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["query", "type", ], str]):
