...
class ReplicaSetAlertViewForNdsGroup(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["acknowledgedUntil", "alertConfigId", "created", "eventTypeName", "id", "status", "updated", "acknowledgementComment", "acknowledgingUsername", "clusterName", "groupId", "hostnameAndPort", "lastNotified", "links", "nonRunningHostIds", "orgId", "parentClusterId", "replicaSetName", "resolved", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eventTypeName"]) -> 'ReplicaSetEventTypeViewForNdsGroupAlertable': ...
