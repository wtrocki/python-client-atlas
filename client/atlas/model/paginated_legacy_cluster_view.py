...
class PaginatedLegacyClusterView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['LegacyClusterDescription']:
                        return LegacyClusterDescription
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['LegacyClusterDescription'], typing.List['LegacyClusterDescription']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'LegacyClusterDescription':
                    return super().__getitem__(i)
