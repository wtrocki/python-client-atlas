        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApiSnapshotView']:
                        return ApiSnapshotView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApiSnapshotView'], typing.List['ApiSnapshotView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ApiSnapshotView':
                    return super().__getitem__(i)
