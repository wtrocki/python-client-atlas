...
class ServerlessBackupRestoreJob(BaseModel):
    ...
    __properties = ["cancelled", "deliveryType", "deliveryUrl", "desiredTimestamp", "expired", "expiresAt", "failed", "finishedAt", "id", "links", "oplogInc", "oplogTs", "pointInTimeUTCSeconds", "snapshotId", "targetClusterName", "targetGroupId", "timestamp"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerlessBackupRestoreJob:
        """Create an instance of ServerlessBackupRestoreJob from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerlessBackupRestoreJob:
        """Create an instance of ServerlessBackupRestoreJob from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerlessBackupRestoreJob.parse_obj(obj)

        _obj = ServerlessBackupRestoreJob.parse_obj({
