...
class NDSX509UserAuthenticationAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: NDSX509UserAuthenticationEventTypeViewAlertable = Field(..., alias="eventTypeName")
    ...
    threshold: Optional[LessThanDaysThresholdView] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NDSX509UserAuthenticationAlertConfigViewForNdsGroup:
        """Create an instance of NDSX509UserAuthenticationAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NDSX509UserAuthenticationAlertConfigViewForNdsGroup:
        """Create an instance of NDSX509UserAuthenticationAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NDSX509UserAuthenticationAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = NDSX509UserAuthenticationAlertConfigViewForNdsGroup.parse_obj({
            ...
            "threshold": LessThanDaysThresholdView.from_dict(obj.get("threshold")) if obj.get("threshold") is not None else None,
