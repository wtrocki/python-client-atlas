...
class HostEventViewForNdsGroup(BaseModel):
    ...
    event_type_name: HostEventTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "port", "publicKey", "raw", "remoteAddress", "replicaSetName", "shardName", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostEventViewForNdsGroup:
        """Create an instance of HostEventViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HostEventViewForNdsGroup:
        """Create an instance of HostEventViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return HostEventViewForNdsGroup.parse_obj(obj)

        _obj = HostEventViewForNdsGroup.parse_obj({
