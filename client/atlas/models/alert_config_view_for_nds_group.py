...
class AlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: Optional[ServerlessEventTypeViewAlertable] = Field(None, alias="eventTypeName")
    ...
    __properties = ["created", "enabled", "eventTypeName", "groupId", "id", "links", "matchers", "notifications", "updated", "metricThreshold", "threshold"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertConfigViewForNdsGroup:
        """Create an instance of AlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlertConfigViewForNdsGroup:
        """Create an instance of AlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = AlertConfigViewForNdsGroup.parse_obj({
