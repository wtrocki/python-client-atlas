...
class SummaryNotificationView(BaseModel):
    ...
    def type_name_validate_enum(cls, v):
        if v not in ('SUMMARY'):
            raise ValueError("must validate the enum values ('SUMMARY')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SummaryNotificationView:
        """Create an instance of SummaryNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SummaryNotificationView:
        """Create an instance of SummaryNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SummaryNotificationView.parse_obj(obj)

        _obj = SummaryNotificationView.parse_obj({
