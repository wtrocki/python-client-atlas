...
class AppServiceAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: AppServiceEventTypeViewAlertableNoThreshold = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppServiceAlertConfigViewForNdsGroup:
        """Create an instance of AppServiceAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppServiceAlertConfigViewForNdsGroup:
        """Create an instance of AppServiceAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AppServiceAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = AppServiceAlertConfigViewForNdsGroup.parse_obj({
