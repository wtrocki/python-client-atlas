...
class EventViewForOrg(BaseModel):
    ...
    event_type_name: Optional[UserEventTypeViewForOrg] = Field(None, alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username", "alertId", "alertConfigId", "invoiceId", "paymentId", "whitelistEntry", "teamId", "targetUsername"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventViewForOrg:
        """Create an instance of EventViewForOrg from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventViewForOrg:
        """Create an instance of EventViewForOrg from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EventViewForOrg.parse_obj(obj)

        _obj = EventViewForOrg.parse_obj({
