...
class ApiDiskPartitionView(BaseModel):
    ...
    __properties = ["links", "partitionName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiDiskPartitionView:
        """Create an instance of ApiDiskPartitionView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiDiskPartitionView:
        """Create an instance of ApiDiskPartitionView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiDiskPartitionView.parse_obj(obj)

        _obj = ApiDiskPartitionView.parse_obj({
