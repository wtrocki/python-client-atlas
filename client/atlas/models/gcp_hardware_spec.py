...
class GCPHardwareSpec(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GCPHardwareSpec:
        """Create an instance of GCPHardwareSpec from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GCPHardwareSpec:
        """Create an instance of GCPHardwareSpec from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GCPHardwareSpec.parse_obj(obj)

        _obj = GCPHardwareSpec.parse_obj({
