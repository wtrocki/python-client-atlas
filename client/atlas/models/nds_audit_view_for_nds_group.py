...
class NDSAuditViewForNdsGroup(BaseModel):
    ...
    event_type_name: NDSAuditTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username", "whitelistEntry"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NDSAuditViewForNdsGroup:
        """Create an instance of NDSAuditViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NDSAuditViewForNdsGroup:
        """Create an instance of NDSAuditViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NDSAuditViewForNdsGroup.parse_obj(obj)

        _obj = NDSAuditViewForNdsGroup.parse_obj({
