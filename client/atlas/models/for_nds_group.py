...
class ForNdsGroup(BaseModel):
    ...
    event_type_name: ReplicaSetEventTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    __properties = ["created", "eventTypeName", "groupId", "id", "links", "orgId", "port", "raw", "replicaSetName", "shardName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ForNdsGroup:
        """Create an instance of ForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ForNdsGroup:
        """Create an instance of ForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ForNdsGroup.parse_obj(obj)

        _obj = ForNdsGroup.parse_obj({
