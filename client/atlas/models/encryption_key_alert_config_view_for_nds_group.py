...
class EncryptionKeyAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: EncryptionKeyEventTypeViewAlertable = Field(..., alias="eventTypeName")
    ...
    threshold: Optional[GreaterThanDaysThresholdView] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncryptionKeyAlertConfigViewForNdsGroup:
        """Create an instance of EncryptionKeyAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncryptionKeyAlertConfigViewForNdsGroup:
        """Create an instance of EncryptionKeyAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EncryptionKeyAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = EncryptionKeyAlertConfigViewForNdsGroup.parse_obj({
            ...
            "threshold": GreaterThanDaysThresholdView.from_dict(obj.get("threshold")) if obj.get("threshold") is not None else None,
