...
class NDSAuditViewForOrg(BaseModel):
    ...
    event_type_name: NDSAuditTypeViewForOrg = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NDSAuditViewForOrg:
        """Create an instance of NDSAuditViewForOrg from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NDSAuditViewForOrg:
        """Create an instance of NDSAuditViewForOrg from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NDSAuditViewForOrg.parse_obj(obj)

        _obj = NDSAuditViewForOrg.parse_obj({
