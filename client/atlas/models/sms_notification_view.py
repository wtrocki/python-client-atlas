...
class SMSNotificationView(BaseModel):
    ...
    mobile_number: Optional[StrictStr] = Field(None, alias="mobileNumber", description="Mobile phone number to which MongoDB Cloud sends alert notifications. The resource requires this parameter when `\"notifications.[n].typeName\" : \"SMS\"`.")
    type_name: StrictStr = Field(..., alias="typeName", description="Human-readable label that displays the alert notification type.")
    __properties = ["delayMin", "intervalMin", "mobileNumber", "typeName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SMSNotificationView:
        """Create an instance of SMSNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SMSNotificationView:
        """Create an instance of SMSNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SMSNotificationView.parse_obj(obj)

        _obj = SMSNotificationView.parse_obj({
