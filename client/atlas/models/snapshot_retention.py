...
class SnapshotRetention(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnapshotRetention:
        """Create an instance of SnapshotRetention from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnapshotRetention:
        """Create an instance of SnapshotRetention from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SnapshotRetention.parse_obj(obj)

        _obj = SnapshotRetention.parse_obj({
