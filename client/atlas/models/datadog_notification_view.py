...
class DatadogNotificationView(BaseModel):
    ...
    __properties = ["datadogApiKey", "datadogRegion", "delayMin", "intervalMin", "typeName"]

    @validator('datadog_region')
    def datadog_region_validate_enum(cls, v):
        if v is None:
            return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatadogNotificationView:
        """Create an instance of DatadogNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatadogNotificationView:
        """Create an instance of DatadogNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DatadogNotificationView.parse_obj(obj)

        _obj = DatadogNotificationView.parse_obj({
            "datadog_api_key": obj.get("datadogApiKey"),
            "datadog_region": obj.get("datadogRegion") if obj.get("datadogRegion") is not None else 'US',
