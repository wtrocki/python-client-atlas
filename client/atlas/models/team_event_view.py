...
class TeamEventView(BaseModel):
    ...
    event_type_name: TeamEventTypeView = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamEventView:
        """Create an instance of TeamEventView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamEventView:
        """Create an instance of TeamEventView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TeamEventView.parse_obj(obj)

        _obj = TeamEventView.parse_obj({
