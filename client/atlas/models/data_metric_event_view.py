...
class DataMetricEventView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataMetricEventView:
        """Create an instance of DataMetricEventView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataMetricEventView:
        """Create an instance of DataMetricEventView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataMetricEventView.parse_obj(obj)

        _obj = DataMetricEventView.parse_obj({
