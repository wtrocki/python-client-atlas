...
class LessThanTimeThresholdAlertConfigViewForNdsGroup(BaseModel):
    ...
    threshold: Optional[LessThanTimeThresholdView] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LessThanTimeThresholdAlertConfigViewForNdsGroup:
        """Create an instance of LessThanTimeThresholdAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LessThanTimeThresholdAlertConfigViewForNdsGroup:
        """Create an instance of LessThanTimeThresholdAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LessThanTimeThresholdAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = LessThanTimeThresholdAlertConfigViewForNdsGroup.parse_obj({
            ...
            "threshold": LessThanTimeThresholdView.from_dict(obj.get("threshold")) if obj.get("threshold") is not None else None,
