...
class MonthlyScheduleView(BaseModel):
    ...
    """
    day_of_month: Optional[conint(strict=True, le=31, ge=1)] = Field(None, alias="dayOfMonth", description="Day of the month when the scheduled archive starts.")
    ...
    type: StrictStr = ...
    __properties = ["dayOfMonth", "endHour", "endMinute", "startHour", "startMinute", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonthlyScheduleView:
        """Create an instance of MonthlyScheduleView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonthlyScheduleView:
        """Create an instance of MonthlyScheduleView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MonthlyScheduleView.parse_obj(obj)

        _obj = MonthlyScheduleView.parse_obj({
