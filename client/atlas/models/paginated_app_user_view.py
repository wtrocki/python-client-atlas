...
class PaginatedAppUserView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedAppUserView:
        """Create an instance of PaginatedAppUserView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedAppUserView:
        """Create an instance of PaginatedAppUserView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PaginatedAppUserView.parse_obj(obj)

        _obj = PaginatedAppUserView.parse_obj({
