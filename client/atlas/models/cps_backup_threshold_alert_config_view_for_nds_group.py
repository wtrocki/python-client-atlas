...
class CpsBackupThresholdAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: CpsBackupEventTypeViewForNdsGroupAlertableWithThreshold = Field(..., alias="eventTypeName")
    ...
    threshold: Optional[GreaterThanTimeThresholdView] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CpsBackupThresholdAlertConfigViewForNdsGroup:
        """Create an instance of CpsBackupThresholdAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CpsBackupThresholdAlertConfigViewForNdsGroup:
        """Create an instance of CpsBackupThresholdAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CpsBackupThresholdAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = CpsBackupThresholdAlertConfigViewForNdsGroup.parse_obj({
            ...
            "threshold": GreaterThanTimeThresholdView.from_dict(obj.get("threshold")) if obj.get("threshold") is not None else None,
