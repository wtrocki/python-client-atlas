...
class GreaterThanRawThresholdAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: ReplicaSetEventTypeViewForNdsGroupAlertableWithThreshold = Field(..., alias="eventTypeName")
    ...
    threshold: Optional[GreaterThanRawThresholdView] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GreaterThanRawThresholdAlertConfigViewForNdsGroup:
        """Create an instance of GreaterThanRawThresholdAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GreaterThanRawThresholdAlertConfigViewForNdsGroup:
        """Create an instance of GreaterThanRawThresholdAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GreaterThanRawThresholdAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = GreaterThanRawThresholdAlertConfigViewForNdsGroup.parse_obj({
            ...
            "threshold": GreaterThanRawThresholdView.from_dict(obj.get("threshold")) if obj.get("threshold") is not None else None,
