...
class FTSIndexAuditView(BaseModel):
    ...
    event_type_name: FTSIndexAuditTypeView = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FTSIndexAuditView:
        """Create an instance of FTSIndexAuditView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FTSIndexAuditView:
        """Create an instance of FTSIndexAuditView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FTSIndexAuditView.parse_obj(obj)

        _obj = FTSIndexAuditView.parse_obj({
