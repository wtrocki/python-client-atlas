...
class TimeMetricEventView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeMetricEventView:
        """Create an instance of TimeMetricEventView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeMetricEventView:
        """Create an instance of TimeMetricEventView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TimeMetricEventView.parse_obj(obj)

        _obj = TimeMetricEventView.parse_obj({
