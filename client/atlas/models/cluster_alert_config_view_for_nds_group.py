...
class ClusterAlertConfigViewForNdsGroup(BaseModel):
    ...
    matchers: Optional[List[ClusterMatcherView]] = Field(None, description="List of rules that determine whether MongoDB Cloud checks an object for the alert configuration. You can filter using the matchers array if the **eventTypeName** specifies an event for a host, replica set, or sharded cluster.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterAlertConfigViewForNdsGroup:
        """Create an instance of ClusterAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterAlertConfigViewForNdsGroup:
        """Create an instance of ClusterAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ClusterAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = ClusterAlertConfigViewForNdsGroup.parse_obj({
            ...
            "matchers": [ClusterMatcherView.from_dict(_item) for _item in obj.get("matchers")] if obj.get("matchers") is not None else None,
