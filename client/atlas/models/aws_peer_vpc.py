...
class AWSPeerVpc(BaseModel):
    ...
    __properties = ["accepterRegionName", "awsAccountId", "connectionId", "containerId", "errorStateName", "id", "routeTableCidrBlock", "statusName", "vpcId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AWSPeerVpc:
        """Create an instance of AWSPeerVpc from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AWSPeerVpc:
        """Create an instance of AWSPeerVpc from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AWSPeerVpc.parse_obj(obj)

        _obj = AWSPeerVpc.parse_obj({
