...
class SlackNotificationView(BaseModel):
    ...
    __properties = ["apiToken", "channelName", "delayMin", "intervalMin", "typeName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SlackNotificationView:
        """Create an instance of SlackNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SlackNotificationView:
        """Create an instance of SlackNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SlackNotificationView.parse_obj(obj)

        _obj = SlackNotificationView.parse_obj({
