...
class AWSHardwareSpec(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AWSHardwareSpec:
        """Create an instance of AWSHardwareSpec from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AWSHardwareSpec:
        """Create an instance of AWSHardwareSpec from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AWSHardwareSpec.parse_obj(obj)

        _obj = AWSHardwareSpec.parse_obj({
