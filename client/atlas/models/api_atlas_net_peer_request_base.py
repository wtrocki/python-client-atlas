...
class ApiAtlasNetPeerRequestBase(BaseModel):
    ...
    __properties = ["containerId", "providerName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiAtlasNetPeerRequestBase:
        """Create an instance of ApiAtlasNetPeerRequestBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiAtlasNetPeerRequestBase:
        """Create an instance of ApiAtlasNetPeerRequestBase from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiAtlasNetPeerRequestBase.parse_obj(obj)

        _obj = ApiAtlasNetPeerRequestBase.parse_obj({
