...
class AlertConfigAuditView(BaseModel):
    ...
    event_type_name: AlertConfigAuditTypeView = Field(..., alias="eventTypeName")
    ...
    __properties = ["alertConfigId", "apiKeyId", "created", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertConfigAuditView:
        """Create an instance of AlertConfigAuditView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlertConfigAuditView:
        """Create an instance of AlertConfigAuditView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlertConfigAuditView.parse_obj(obj)

        _obj = AlertConfigAuditView.parse_obj({
