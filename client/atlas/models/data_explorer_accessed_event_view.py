...
class DataExplorerAccessedEventView(BaseModel):
    ...
    event_type_name: DataExplorerAccessedEventTypeView = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "collection", "created", "database", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "opType", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataExplorerAccessedEventView:
        """Create an instance of DataExplorerAccessedEventView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataExplorerAccessedEventView:
        """Create an instance of DataExplorerAccessedEventView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataExplorerAccessedEventView.parse_obj(obj)

        _obj = DataExplorerAccessedEventView.parse_obj({
