...
class UserEventViewForOrg(BaseModel):
    ...
    event_type_name: UserEventTypeViewForOrg = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserEventViewForOrg:
        """Create an instance of UserEventViewForOrg from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserEventViewForOrg:
        """Create an instance of UserEventViewForOrg from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UserEventViewForOrg.parse_obj(obj)

        _obj = UserEventViewForOrg.parse_obj({
