...
class OrgNotificationView(BaseModel):
    ...
    def type_name_validate_enum(cls, v):
        if v not in ('ORG'):
            raise ValueError("must validate the enum values ('ORG')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrgNotificationView:
        """Create an instance of OrgNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrgNotificationView:
        """Create an instance of OrgNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OrgNotificationView.parse_obj(obj)

        _obj = OrgNotificationView.parse_obj({
