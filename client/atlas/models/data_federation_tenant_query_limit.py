...
class DataFederationTenantQueryLimit(BaseModel):
    ...
    tenant_name: Optional[StrictStr] = Field(None, alias="tenantName", description="Human-readable label that identifies the Federated Database Instance. If specified, the usage limit is for the specified federated database instance only. If omitted, the usage limit is for all federated database instances in the project.")
    value: StrictInt = Field(..., description="Amount to set the limit to.")
    __properties = ["currentUsage", "defaultLimit", "lastModifiedDate", "maximumLimit", "name", "overrunPolicy", "tenantName", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataFederationTenantQueryLimit:
        """Create an instance of DataFederationTenantQueryLimit from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataFederationTenantQueryLimit:
        """Create an instance of DataFederationTenantQueryLimit from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataFederationTenantQueryLimit.parse_obj(obj)

        _obj = DataFederationTenantQueryLimit.parse_obj({
