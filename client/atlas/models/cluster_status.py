...
class ClusterStatus(BaseModel):
    ...
    """
    change_status: Optional[StrictStr] = Field(None, alias="changeStatus", description="State of cluster at the time of this request.")
    ...
    __properties = ["changeStatus", "links"]

    @validator('change_status')
    def change_status_validate_enum(cls, v):
        if v is None:
            return v

        if v not in ('PENDING', 'APPLIED'):
            raise ValueError("must validate the enum values ('PENDING', 'APPLIED')")
        return v
    ...
    def from_dict(cls, obj: dict) -> ClusterStatus:
        ...
        _obj = ClusterStatus.parse_obj({
            "change_status": obj.get("changeStatus"),
