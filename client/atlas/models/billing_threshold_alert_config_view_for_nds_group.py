...
class BillingThresholdAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: BillingEventTypeViewAlertableWithThreshold = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingThresholdAlertConfigViewForNdsGroup:
        """Create an instance of BillingThresholdAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingThresholdAlertConfigViewForNdsGroup:
        """Create an instance of BillingThresholdAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BillingThresholdAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = BillingThresholdAlertConfigViewForNdsGroup.parse_obj({
