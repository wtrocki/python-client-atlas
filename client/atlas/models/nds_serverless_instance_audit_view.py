...
class NDSServerlessInstanceAuditView(BaseModel):
    ...
    event_type_name: NDSServerlessInstanceAuditTypeView = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NDSServerlessInstanceAuditView:
        """Create an instance of NDSServerlessInstanceAuditView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NDSServerlessInstanceAuditView:
        """Create an instance of NDSServerlessInstanceAuditView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NDSServerlessInstanceAuditView.parse_obj(obj)

        _obj = NDSServerlessInstanceAuditView.parse_obj({
