...
NOTIFICATIONVIEW_ONE_OF_SCHEMAS = ["DatadogNotificationView", "EmailNotificationView", "GroupNotificationView", "HipChatNotificationView", "MicrosoftTeamsNotificationView", "NDSNotificationView", "OpsGenieNotificationView", "OrgNotificationView", "PagerDutyNotificationView", "SMSNotificationView", "SlackNotificationView", "SummaryNotificationView", "TeamNotificationView", "UserNotificationView", "VictorOpsNotificationView", "WebhookNotificationView"]
...
class NotificationView(BaseModel):
    ...
    # data type: NDSNotificationView
    oneof_schema_6_validator: Optional[NDSNotificationView] = None
    # data type: OpsGenieNotificationView
    oneof_schema_7_validator: Optional[OpsGenieNotificationView] = None
    # data type: OrgNotificationView
    oneof_schema_8_validator: Optional[OrgNotificationView] = None
    # data type: PagerDutyNotificationView
    oneof_schema_9_validator: Optional[PagerDutyNotificationView] = None
    # data type: SlackNotificationView
    oneof_schema_10_validator: Optional[SlackNotificationView] = None
    # data type: SMSNotificationView
    oneof_schema_11_validator: Optional[SMSNotificationView] = None
    # data type: SummaryNotificationView
    oneof_schema_12_validator: Optional[SummaryNotificationView] = None
    # data type: TeamNotificationView
    oneof_schema_13_validator: Optional[TeamNotificationView] = None
    # data type: UserNotificationView
    oneof_schema_14_validator: Optional[UserNotificationView] = None
    # data type: VictorOpsNotificationView
    oneof_schema_15_validator: Optional[VictorOpsNotificationView] = None
    # data type: WebhookNotificationView
    oneof_schema_16_validator: Optional[WebhookNotificationView] = None
    actual_instance: Any
    one_of_schemas: List[str] = Field(NOTIFICATIONVIEW_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        # validate data type: NDSNotificationView
        if type(v) is not NDSNotificationView:
            error_messages.append(f"Error! Input type `{type(v)}` is not `NDSNotificationView`")
        else:
            match += 1
        ...
        # validate data type: SummaryNotificationView
        if type(v) is not SummaryNotificationView:
            error_messages.append(f"Error! Input type `{type(v)}` is not `SummaryNotificationView`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into NotificationView with oneOf schemas: DatadogNotificationView, EmailNotificationView, GroupNotificationView, HipChatNotificationView, MicrosoftTeamsNotificationView, NDSNotificationView, OpsGenieNotificationView, OrgNotificationView, PagerDutyNotificationView, SMSNotificationView, SlackNotificationView, SummaryNotificationView, TeamNotificationView, UserNotificationView, VictorOpsNotificationView, WebhookNotificationView. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationView:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> NotificationView:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into NDSNotificationView
        try:
            instance.actual_instance = NDSNotificationView.from_json(json_str)
            match += 1
        except ValidationError as e:
            error_messages.append(str(e))
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into SummaryNotificationView
        try:
            instance.actual_instance = SummaryNotificationView.from_json(json_str)
            match += 1
        except ValidationError as e:
            error_messages.append(str(e))
