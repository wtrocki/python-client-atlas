...
class BillingEventViewForOrg(BaseModel):
    ...
    event_type_name: BillingEventTypeViewForOrg = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingEventViewForOrg:
        """Create an instance of BillingEventViewForOrg from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingEventViewForOrg:
        """Create an instance of BillingEventViewForOrg from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BillingEventViewForOrg.parse_obj(obj)

        _obj = BillingEventViewForOrg.parse_obj({
