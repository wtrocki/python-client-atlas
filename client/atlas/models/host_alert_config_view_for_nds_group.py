...
class HostAlertConfigViewForNdsGroup(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HostAlertConfigViewForNdsGroup:
        """Create an instance of HostAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HostAlertConfigViewForNdsGroup:
        """Create an instance of HostAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return HostAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = HostAlertConfigViewForNdsGroup.parse_obj({
