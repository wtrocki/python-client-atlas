...
class ContainerPeer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerPeer:
        """Create an instance of ContainerPeer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContainerPeer:
        """Create an instance of ContainerPeer from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ContainerPeer.parse_obj(obj)

        _obj = ContainerPeer.parse_obj({
