...
class BillingEventViewForNdsGroup(BaseModel):
    ...
    event_type_name: BillingEventTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "eventTypeName", "groupId", "id", "invoiceId", "isGlobalAdmin", "links", "orgId", "paymentId", "publicKey", "raw", "remoteAddress", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingEventViewForNdsGroup:
        """Create an instance of BillingEventViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingEventViewForNdsGroup:
        """Create an instance of BillingEventViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BillingEventViewForNdsGroup.parse_obj(obj)

        _obj = BillingEventViewForNdsGroup.parse_obj({
