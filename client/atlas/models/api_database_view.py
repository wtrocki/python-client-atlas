...
class ApiDatabaseView(BaseModel):
    ...
    __properties = ["databaseName", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiDatabaseView:
        """Create an instance of ApiDatabaseView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiDatabaseView:
        """Create an instance of ApiDatabaseView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiDatabaseView.parse_obj(obj)

        _obj = ApiDatabaseView.parse_obj({
