...
class AzureRegionConfig(BaseModel):
    ...
    """
    analytics_auto_scaling: Optional[AutoScalingV15] = Field(None, alias="analyticsAutoScaling")
    analytics_specs: Optional[DedicatedHardwareSpec] = Field(None, alias="analyticsSpecs")
    auto_scaling: Optional[AutoScalingV15] = Field(None, alias="autoScaling")
    read_only_specs: Optional[DedicatedHardwareSpec] = Field(None, alias="readOnlySpecs")
    ...
    __properties = ["analyticsAutoScaling", "analyticsSpecs", "autoScaling", "readOnlySpecs", "electableSpecs", "priority", "providerName", "regionName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureRegionConfig:
        """Create an instance of AzureRegionConfig from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of analytics_auto_scaling
        if self.analytics_auto_scaling:
            _dict['analyticsAutoScaling'] = self.analytics_auto_scaling.to_dict()
        # override the default output from pydantic by calling `to_dict()` of analytics_specs
        if self.analytics_specs:
            _dict['analyticsSpecs'] = self.analytics_specs.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of read_only_specs
        if self.read_only_specs:
            _dict['readOnlySpecs'] = self.read_only_specs.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureRegionConfig:
        """Create an instance of AzureRegionConfig from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AzureRegionConfig.parse_obj(obj)

        _obj = AzureRegionConfig.parse_obj({
            "analytics_auto_scaling": AutoScalingV15.from_dict(obj.get("analyticsAutoScaling")) if obj.get("analyticsAutoScaling") is not None else None,
            "analytics_specs": DedicatedHardwareSpec.from_dict(obj.get("analyticsSpecs")) if obj.get("analyticsSpecs") is not None else None,
            "auto_scaling": AutoScalingV15.from_dict(obj.get("autoScaling")) if obj.get("autoScaling") is not None else None,
            "read_only_specs": DedicatedHardwareSpec.from_dict(obj.get("readOnlySpecs")) if obj.get("readOnlySpecs") is not None else None,
