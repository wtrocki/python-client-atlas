...
class AppServiceMetricAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: AppServiceEventTypeViewAlertableWithThreshold = Field(..., alias="eventTypeName")
    ...
    matchers: Optional[List[AppServiceMetricMatcherView]] = Field(None, description="List of rules that determine whether MongoDB Cloud checks an object for the alert configuration. You can filter using the matchers array if the **eventTypeName** specifies an event for a host, replica set, or sharded cluster.")
    metric_threshold: Optional[AppServiceMetricThresholdView] = Field(None, alias="metricThreshold")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppServiceMetricAlertConfigViewForNdsGroup:
        """Create an instance of AppServiceMetricAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppServiceMetricAlertConfigViewForNdsGroup:
        """Create an instance of AppServiceMetricAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AppServiceMetricAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = AppServiceMetricAlertConfigViewForNdsGroup.parse_obj({
            ...
            "matchers": [AppServiceMetricMatcherView.from_dict(_item) for _item in obj.get("matchers")] if obj.get("matchers") is not None else None,
            "metric_threshold": AppServiceMetricThresholdView.from_dict(obj.get("metricThreshold")) if obj.get("metricThreshold") is not None else None,
