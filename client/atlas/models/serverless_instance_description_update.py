...
class ServerlessInstanceDescriptionUpdate(BaseModel):
    ...
    __properties = ["serverlessBackupOptions", "terminationProtectionEnabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerlessInstanceDescriptionUpdate:
        """Create an instance of ServerlessInstanceDescriptionUpdate from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerlessInstanceDescriptionUpdate:
        """Create an instance of ServerlessInstanceDescriptionUpdate from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerlessInstanceDescriptionUpdate.parse_obj(obj)

        _obj = ServerlessInstanceDescriptionUpdate.parse_obj({
