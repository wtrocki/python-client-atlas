...
class NDSTenantEndpointAuditView(BaseModel):
    ...
    event_type_name: NDSTenantEndpointAuditTypeView = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "endpointId", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "providerEndpointId", "publicKey", "raw", "remoteAddress", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NDSTenantEndpointAuditView:
        """Create an instance of NDSTenantEndpointAuditView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NDSTenantEndpointAuditView:
        """Create an instance of NDSTenantEndpointAuditView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NDSTenantEndpointAuditView.parse_obj(obj)

        _obj = NDSTenantEndpointAuditView.parse_obj({
