...
HOSTMETRICEVENTVIEW_ONE_OF_SCHEMAS = ["DataMetricEventView", "NumberMetricEventView", "RawMetricEventView", "TimeMetricEventView"]

class HostMetricEventView(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    # data type: RawMetricEventView
    oneof_schema_1_validator: Optional[RawMetricEventView] = None
    # data type: TimeMetricEventView
    oneof_schema_2_validator: Optional[TimeMetricEventView] = None
    # data type: DataMetricEventView
    oneof_schema_3_validator: Optional[DataMetricEventView] = None
    # data type: NumberMetricEventView
    oneof_schema_4_validator: Optional[NumberMetricEventView] = None
    actual_instance: Any
    one_of_schemas: List[str] = Field(HOSTMETRICEVENTVIEW_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        error_messages = []
        match = 0
        # validate data type: RawMetricEventView
        if type(v) is not RawMetricEventView:
            error_messages.append(f"Error! Input type `{type(v)}` is not `RawMetricEventView`")
        else:
            match += 1

        # validate data type: TimeMetricEventView
        if type(v) is not TimeMetricEventView:
            error_messages.append(f"Error! Input type `{type(v)}` is not `TimeMetricEventView`")
        else:
            match += 1

        # validate data type: DataMetricEventView
        if type(v) is not DataMetricEventView:
            error_messages.append(f"Error! Input type `{type(v)}` is not `DataMetricEventView`")
        else:
            match += 1

        # validate data type: NumberMetricEventView
        if type(v) is not NumberMetricEventView:
            error_messages.append(f"Error! Input type `{type(v)}` is not `NumberMetricEventView`")
        else:
            match += 1

        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into HostMetricEventView with oneOf schemas: DataMetricEventView, NumberMetricEventView, RawMetricEventView, TimeMetricEventView. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into HostMetricEventView with oneOf schemas: DataMetricEventView, NumberMetricEventView, RawMetricEventView, TimeMetricEventView. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> HostMetricEventView:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> HostMetricEventView:
        ...
        # check if data type is `RawMetricEventView`
        if _data_type == "ASSERT_MSG":
            instance.actual_instance = RawMetricEventView.from_json(json_str)
            return instance
        ...
        # check if data type is `TimeMetricEventView`
        if _data_type == "AVG_COMMAND_EXECUTION_TIME":
            instance.actual_instance = TimeMetricEventView.from_json(json_str)
            return instance
        ...
        # check if data type is `DataMetricEventView`
        if _data_type == "CACHE_BYTES_READ_INTO":
            instance.actual_instance = DataMetricEventView.from_json(json_str)
            return instance
        ...
        # check if data type is `DataMetricEventView`
        if _data_type == "DataMetricEventView":
            instance.actual_instance = DataMetricEventView.from_json(json_str)
            return instance
        ...
        # check if data type is `NumberMetricEventView`
        if _data_type == "NumberMetricEventView":
            instance.actual_instance = NumberMetricEventView.from_json(json_str)
            return instance
        ...
        # check if data type is `RawMetricEventView`
        if _data_type == "RawMetricEventView":
            instance.actual_instance = RawMetricEventView.from_json(json_str)
            return instance
        ...
        # check if data type is `TimeMetricEventView`
        if _data_type == "TimeMetricEventView":
            instance.actual_instance = TimeMetricEventView.from_json(json_str)
            return instance

        # deserialize data into RawMetricEventView
        try:
            instance.actual_instance = RawMetricEventView.from_json(json_str)
            match += 1
        except ValidationError as e:
            error_messages.append(str(e))
        # deserialize data into TimeMetricEventView
        try:
            instance.actual_instance = TimeMetricEventView.from_json(json_str)
            match += 1
        except ValidationError as e:
            error_messages.append(str(e))
        # deserialize data into DataMetricEventView
        try:
            instance.actual_instance = DataMetricEventView.from_json(json_str)
            match += 1
        except ValidationError as e:
            error_messages.append(str(e))
        # deserialize data into NumberMetricEventView
        try:
            instance.actual_instance = NumberMetricEventView.from_json(json_str)
            match += 1
        except ValidationError as e:
