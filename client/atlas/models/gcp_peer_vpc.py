...
class GCPPeerVpc(BaseModel):
    ...
    __properties = ["containerId", "errorMessage", "gcpProjectId", "id", "networkName", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GCPPeerVpc:
        """Create an instance of GCPPeerVpc from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GCPPeerVpc:
        """Create an instance of GCPPeerVpc from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GCPPeerVpc.parse_obj(obj)

        _obj = GCPPeerVpc.parse_obj({
