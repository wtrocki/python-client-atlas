...
class GCPComputeAutoScaling(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GCPComputeAutoScaling:
        """Create an instance of GCPComputeAutoScaling from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GCPComputeAutoScaling:
        """Create an instance of GCPComputeAutoScaling from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GCPComputeAutoScaling.parse_obj(obj)

        _obj = GCPComputeAutoScaling.parse_obj({
