...
class UserEventViewForNdsGroup(BaseModel):
    ...
    event_type_name: UserEventTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "targetUsername", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserEventViewForNdsGroup:
        """Create an instance of UserEventViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserEventViewForNdsGroup:
        """Create an instance of UserEventViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UserEventViewForNdsGroup.parse_obj(obj)

        _obj = UserEventViewForNdsGroup.parse_obj({
