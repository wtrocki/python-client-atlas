...
class AlertAuditView(BaseModel):
    ...
    event_type_name: AlertAuditTypeView = Field(..., alias="eventTypeName")
    ...
    __properties = ["alertId", "apiKeyId", "created", "eventTypeName", "groupId", "id", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertAuditView:
        """Create an instance of AlertAuditView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlertAuditView:
        """Create an instance of AlertAuditView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlertAuditView.parse_obj(obj)

        _obj = AlertAuditView.parse_obj({
