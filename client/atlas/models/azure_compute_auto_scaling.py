...
class AzureComputeAutoScaling(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureComputeAutoScaling:
        """Create an instance of AzureComputeAutoScaling from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureComputeAutoScaling:
        """Create an instance of AzureComputeAutoScaling from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AzureComputeAutoScaling.parse_obj(obj)

        _obj = AzureComputeAutoScaling.parse_obj({
