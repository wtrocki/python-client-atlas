...
class AlertConfigView(BaseModel):
    ...
    notifications: Optional[List[NotificationView]] = Field(None, description="List that contains the targets that MongoDB Cloud sends notifications.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertConfigView:
        """Create an instance of AlertConfigView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlertConfigView:
        """Create an instance of AlertConfigView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlertConfigView.parse_obj(obj)

        _obj = AlertConfigView.parse_obj({
            ...
            "notifications": [NotificationView.from_dict(_item) for _item in obj.get("notifications")] if obj.get("notifications") is not None else None,
