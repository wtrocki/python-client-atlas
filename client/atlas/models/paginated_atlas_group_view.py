...
class PaginatedAtlasGroupView(BaseModel):
    ...
    results: Optional[List[Group]] = Field(None, description="List of returned documents that MongoDB Cloud providers when completing this request.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedAtlasGroupView:
        """Create an instance of PaginatedAtlasGroupView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedAtlasGroupView:
        """Create an instance of PaginatedAtlasGroupView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PaginatedAtlasGroupView.parse_obj(obj)

        _obj = PaginatedAtlasGroupView.parse_obj({
