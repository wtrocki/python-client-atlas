...
class ApiUserEventViewForNdsGroup(BaseModel):
    ...
    event_type_name: ApiUserEventTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiUserEventViewForNdsGroup:
        """Create an instance of ApiUserEventViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiUserEventViewForNdsGroup:
        """Create an instance of ApiUserEventViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiUserEventViewForNdsGroup.parse_obj(obj)

        _obj = ApiUserEventViewForNdsGroup.parse_obj({
