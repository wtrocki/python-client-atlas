...
class VictorOpsNotificationView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VictorOpsNotificationView:
        """Create an instance of VictorOpsNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VictorOpsNotificationView:
        """Create an instance of VictorOpsNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VictorOpsNotificationView.parse_obj(obj)

        _obj = VictorOpsNotificationView.parse_obj({
            "delay_min": obj.get("delayMin"),
            "interval_min": obj.get("intervalMin"),
            "type_name": obj.get("typeName"),
            "victor_ops_api_key": obj.get("victorOpsApiKey"),
            "victor_ops_routing_key": obj.get("victorOpsRoutingKey")
        })
        return _obj
