...
class GCPRegionConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GCPRegionConfig:
        """Create an instance of GCPRegionConfig from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GCPRegionConfig:
        """Create an instance of GCPRegionConfig from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GCPRegionConfig.parse_obj(obj)

        _obj = GCPRegionConfig.parse_obj({
