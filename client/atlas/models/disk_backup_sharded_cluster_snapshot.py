...
class DiskBackupShardedClusterSnapshot(BaseModel):
    ...
    members: Optional[List[DiskBackupShardedClusterSnapshotMember]] = Field(None, description="List that includes the snapshots and the cloud provider that stores the snapshots. The resource returns this parameter when `\"type\" : \"SHARDED_CLUSTER\"`.")
    ...
    __properties = ["createdAt", "description", "expiresAt", "frequencyType", "id", "links", "masterKeyUUID", "members", "mongodVersion", "policyItems", "snapshotIds", "snapshotType", "status", "storageSizeBytes", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiskBackupShardedClusterSnapshot:
        """Create an instance of DiskBackupShardedClusterSnapshot from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiskBackupShardedClusterSnapshot:
        """Create an instance of DiskBackupShardedClusterSnapshot from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DiskBackupShardedClusterSnapshot.parse_obj(obj)

        _obj = DiskBackupShardedClusterSnapshot.parse_obj({
            ...
            "members": [DiskBackupShardedClusterSnapshotMember.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None,
            "mongod_version": obj.get("mongodVersion"),
            "policy_items": obj.get("policyItems"),
            "snapshot_ids": obj.get("snapshotIds"),
