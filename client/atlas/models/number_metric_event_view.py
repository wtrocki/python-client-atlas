...
class NumberMetricEventView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NumberMetricEventView:
        """Create an instance of NumberMetricEventView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NumberMetricEventView:
        """Create an instance of NumberMetricEventView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NumberMetricEventView.parse_obj(obj)

        _obj = NumberMetricEventView.parse_obj({
