...
class AutomationConfigEventView(BaseModel):
    ...
    event_type_name: AutomationConfigEventTypeView = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutomationConfigEventView:
        """Create an instance of AutomationConfigEventView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutomationConfigEventView:
        """Create an instance of AutomationConfigEventView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AutomationConfigEventView.parse_obj(obj)

        _obj = AutomationConfigEventView.parse_obj({
