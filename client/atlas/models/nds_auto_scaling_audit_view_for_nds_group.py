...
class NDSAutoScalingAuditViewForNdsGroup(BaseModel):
    ...
    event_type_name: NDSAutoScalingAuditTypeViewForNdsGroup = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NDSAutoScalingAuditViewForNdsGroup:
        """Create an instance of NDSAutoScalingAuditViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NDSAutoScalingAuditViewForNdsGroup:
        """Create an instance of NDSAutoScalingAuditViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NDSAutoScalingAuditViewForNdsGroup.parse_obj(obj)

        _obj = NDSAutoScalingAuditViewForNdsGroup.parse_obj({
