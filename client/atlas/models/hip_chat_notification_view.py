...
class HipChatNotificationView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HipChatNotificationView:
        """Create an instance of HipChatNotificationView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HipChatNotificationView:
        """Create an instance of HipChatNotificationView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return HipChatNotificationView.parse_obj(obj)

        _obj = HipChatNotificationView.parse_obj({
            "delay_min": obj.get("delayMin"),
            "interval_min": obj.get("intervalMin"),
            "notification_token": obj.get("notificationToken"),
