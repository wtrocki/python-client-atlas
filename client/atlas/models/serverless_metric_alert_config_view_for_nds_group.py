...
class ServerlessMetricAlertConfigViewForNdsGroup(BaseModel):
    ...
    event_type_name: ServerlessEventTypeViewAlertable = Field(..., alias="eventTypeName")
    ...
    metric_threshold: Optional[ServerlessMetricThresholdView] = Field(None, alias="metricThreshold")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerlessMetricAlertConfigViewForNdsGroup:
        """Create an instance of ServerlessMetricAlertConfigViewForNdsGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerlessMetricAlertConfigViewForNdsGroup:
        """Create an instance of ServerlessMetricAlertConfigViewForNdsGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerlessMetricAlertConfigViewForNdsGroup.parse_obj(obj)

        _obj = ServerlessMetricAlertConfigViewForNdsGroup.parse_obj({
            ...
            "metric_threshold": ServerlessMetricThresholdView.from_dict(obj.get("metricThreshold")) if obj.get("metricThreshold") is not None else None,
