...
class ServerlessAWSTenantEndpoint(BaseModel):
    ...
    __properties = ["_id", "cloudProviderEndpointId", "comment", "endpointServiceName", "errorMessage", "providerName", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerlessAWSTenantEndpoint:
        """Create an instance of ServerlessAWSTenantEndpoint from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerlessAWSTenantEndpoint:
        """Create an instance of ServerlessAWSTenantEndpoint from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerlessAWSTenantEndpoint.parse_obj(obj)

        _obj = ServerlessAWSTenantEndpoint.parse_obj({
            "id": obj.get("_id"),
