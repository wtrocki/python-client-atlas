...
class OrgEventViewForOrg(BaseModel):
    ...
    event_type_name: OrgEventTypeViewForOrg = Field(..., alias="eventTypeName")
    ...
    __properties = ["apiKeyId", "created", "eventTypeName", "groupId", "id", "invoiceId", "isGlobalAdmin", "links", "orgId", "publicKey", "raw", "remoteAddress", "userId", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrgEventViewForOrg:
        """Create an instance of OrgEventViewForOrg from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrgEventViewForOrg:
        """Create an instance of OrgEventViewForOrg from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OrgEventViewForOrg.parse_obj(obj)

        _obj = OrgEventViewForOrg.parse_obj({
