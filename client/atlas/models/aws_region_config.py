...
class AWSRegionConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AWSRegionConfig:
        """Create an instance of AWSRegionConfig from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AWSRegionConfig:
        """Create an instance of AWSRegionConfig from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AWSRegionConfig.parse_obj(obj)

        _obj = AWSRegionConfig.parse_obj({
