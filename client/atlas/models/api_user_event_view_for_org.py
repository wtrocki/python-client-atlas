...
class ApiUserEventViewForOrg(BaseModel):
    ...
    event_type_name: ApiUserEventTypeViewForOrg = Field(..., alias="eventTypeName")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiUserEventViewForOrg:
        """Create an instance of ApiUserEventViewForOrg from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiUserEventViewForOrg:
        """Create an instance of ApiUserEventViewForOrg from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiUserEventViewForOrg.parse_obj(obj)

        _obj = ApiUserEventViewForOrg.parse_obj({
