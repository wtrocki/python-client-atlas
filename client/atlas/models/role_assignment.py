...
class RoleAssignment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleAssignment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleAssignment:
        """Create an instance of RoleAssignment from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RoleAssignment.parse_obj(obj)

        _obj = RoleAssignment.parse_obj({
