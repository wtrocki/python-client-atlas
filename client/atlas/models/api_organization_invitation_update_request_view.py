...
class ApiOrganizationInvitationUpdateRequestView(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiOrganizationInvitationUpdateRequestView:
        """Create an instance of ApiOrganizationInvitationUpdateRequestView from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiOrganizationInvitationUpdateRequestView:
        """Create an instance of ApiOrganizationInvitationUpdateRequestView from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiOrganizationInvitationUpdateRequestView.parse_obj(obj)

        _obj = ApiOrganizationInvitationUpdateRequestView.parse_obj({
            "roles": obj.get("roles"),
