...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = SnapshotRetention


request_body_snapshot_retention = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DiskBackupReplicaSet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_snapshot_retention_oapg(
        self,
    ...
    def _update_snapshot_retention_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_snapshot_retention.serialize(body, content_type)
...
class UpdateSnapshotRetention(BaseApi):
    ...
    def update_snapshot_retention(
        ...
        return self._update_snapshot_retention_oapg(
            body=body,
