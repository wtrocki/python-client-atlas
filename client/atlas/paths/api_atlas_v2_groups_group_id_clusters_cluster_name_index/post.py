...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiIndexRequestView


request_body_api_index_request_view = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_rolling_index_oapg(
        self,
    ...
    def _create_rolling_index_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_index_request_view.serialize(body, content_type)
...
class CreateRollingIndex(BaseApi):
    ...
    def create_rolling_index(
        ...
        return self._create_rolling_index_oapg(
            body=body,
