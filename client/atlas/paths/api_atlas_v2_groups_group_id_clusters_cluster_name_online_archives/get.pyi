...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedOnlineArchiveView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_online_archives_oapg(
        self,
...
class ListOnlineArchives(BaseApi):
    ...
    def list_online_archives(
        ...
        return self._list_online_archives_oapg(
