...
AuthResultSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'authResult': typing.Union[AuthResultSchema, bool, ],
        'end': typing.Union[EndSchema, str, datetime, ],
        'ipAddress': typing.Union[IpAddressSchema, str, ],
        'nLogs': typing.Union[NLogsSchema, decimal.Decimal, int, ],
...
request_query_auth_result = api_client.QueryParameter(
    name="authResult",
    style=api_client.ParameterStyle.FORM,
...
request_query_n_logs = api_client.QueryParameter(
    name="nLogs",
    style=api_client.ParameterStyle.FORM,
    schema=NLogsSchema,
    explode=True,
...
request_path_hostname = api_client.PathParameter(
    name="hostname",
    style=api_client.ParameterStyle.SIMPLE,
    schema=HostnameSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiMongoDBAccessLogsListView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_access_logs_by_hostname_oapg(
        self,
    ...
    def _list_access_logs_by_hostname_oapg(
        ...
        for parameter in (
            ...
            request_query_auth_result,
            request_query_end,
            request_query_ip_address,
            request_query_n_logs,
            request_query_start,
        ):
...
class ListAccessLogsByHostname(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_access_logs_by_hostname(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_access_logs_by_hostname(
        ...
        return self._list_access_logs_by_hostname_oapg(
