...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = LegacyClusterDescription


request_body_legacy_cluster_description = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = LegacyClusterDescription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upgrade_shared_cluster_oapg(
        self,
    ...
    def _upgrade_shared_cluster_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_legacy_cluster_description.serialize(body, content_type)
...
class UpgradeSharedCluster(BaseApi):
    ...
    def upgrade_shared_cluster(
        ...
        return self._upgrade_shared_cluster_oapg(
            body=body,
