...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = RoleMappingView


request_body_role_mapping_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = RoleMappingView
...
class BaseApi(api_client.Api):
    ...
    def _create_role_mapping_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_role_mapping_view.serialize(body, content_type)
...
class CreateRoleMapping(BaseApi):
    ...
    def create_role_mapping(
        ...
        return self._create_role_mapping_oapg(
            body=body,
