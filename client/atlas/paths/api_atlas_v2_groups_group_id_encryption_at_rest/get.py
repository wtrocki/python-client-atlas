...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = EncryptionAtRest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _return_one_configuration_for_encryption_at_rest_using_customer_managed_keys_for_one_project_oapg(
        self,
...
class ReturnOneConfigurationForEncryptionAtRestUsingCustomerManagedKeysForOneProject(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def return_one_configuration_for_encryption_at_rest_using_customer_managed_keys_for_one_project(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def return_one_configuration_for_encryption_at_rest_using_customer_managed_keys_for_one_project(
        ...
        return self._return_one_configuration_for_encryption_at_rest_using_customer_managed_keys_for_one_project_oapg(
