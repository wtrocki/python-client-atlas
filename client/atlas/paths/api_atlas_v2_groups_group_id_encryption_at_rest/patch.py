...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = EncryptionAtRest


request_body_encryption_at_rest = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_encryption_at_rest_oapg(
        self,
    ...
    def _update_encryption_at_rest_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_encryption_at_rest.serialize(body, content_type)
...
class UpdateEncryptionAtRest(BaseApi):
    ...
    def update_encryption_at_rest(
        ...
        return self._update_encryption_at_rest_oapg(
            body=body,
