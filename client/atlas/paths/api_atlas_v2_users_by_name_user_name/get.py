...
class UserNameSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$',  # noqa: E501
        }]
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_user_by_username_oapg(
        self,
...
class GetUserByUsername(BaseApi):
    ...
    def get_user_by_username(
        ...
        return self._get_user_by_username_oapg(
