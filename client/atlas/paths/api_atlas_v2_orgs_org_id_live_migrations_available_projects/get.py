...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AvailableProjectView']:
            return AvailableProjectView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AvailableProjectView'], typing.List['AvailableProjectView']],
    ...
    def __getitem__(self, i: int) -> 'AvailableProjectView':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_source_projects_oapg(
        self,
...
class ListSourceProjects(BaseApi):
    ...
    def list_source_projects(
        ...
        return self._list_source_projects_oapg(
