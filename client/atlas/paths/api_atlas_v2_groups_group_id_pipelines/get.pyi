...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['IngestionPipeline']:
            return IngestionPipeline

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['IngestionPipeline'], typing.List['IngestionPipeline']],
    ...
    def __getitem__(self, i: int) -> 'IngestionPipeline':
...
class ListPipelines(BaseApi):
    ...
    def list_pipelines(
        ...
        return self._list_pipelines_oapg(
