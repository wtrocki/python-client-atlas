...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'alertConfigId': typing.Union[AlertConfigIdSchema, str, ],
    }
)
...
request_path_alert_config_id = api_client.PathParameter(
    name="alertConfigId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AlertConfigIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedAlertView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_alerts_by_alert_configuration_id_oapg(
        self,
...
class ListAlertsByAlertConfigurationId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_alerts_by_alert_configuration_id(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_alerts_by_alert_configuration_id(
        ...
        return self._list_alerts_by_alert_configuration_id_oapg(
