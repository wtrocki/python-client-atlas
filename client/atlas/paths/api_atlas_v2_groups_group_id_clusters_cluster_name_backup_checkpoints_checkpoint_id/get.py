...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'checkpointId': typing.Union[CheckpointIdSchema, str, ],
...
request_path_checkpoint_id = api_client.PathParameter(
    name="checkpointId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CheckpointIdSchema,
    required=True,
)
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = Checkpoint
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_legacy_backup_checkpoint_oapg(
        self,
...
class GetLegacyBackupCheckpoint(BaseApi):
    ...
    def get_legacy_backup_checkpoint(
        ...
        return self._get_legacy_backup_checkpoint_oapg(
