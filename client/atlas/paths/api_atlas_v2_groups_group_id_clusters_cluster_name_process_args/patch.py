...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ClusterDescriptionProcessArgs


request_body_cluster_description_process_args = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ClusterDescriptionProcessArgs
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_cluster_advanced_configuration_oapg(
        self,
    ...
    def _update_cluster_advanced_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cluster_description_process_args.serialize(body, content_type)
...
class UpdateClusterAdvancedConfiguration(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_cluster_advanced_configuration(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_cluster_advanced_configuration(
        ...
        return self._update_cluster_advanced_configuration_oapg(
            body=body,
