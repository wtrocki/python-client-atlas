...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedDiskPartitionView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_disk_partitions_oapg(
        self,
...
class ListDiskPartitions(BaseApi):
    ...
    def list_disk_partitions(
        ...
        return self._list_disk_partitions_oapg(
