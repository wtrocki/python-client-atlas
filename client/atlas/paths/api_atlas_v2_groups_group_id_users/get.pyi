...
FlattenTeamsSchema = schemas.BoolSchema
IncludeOrgUsersSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'flattenTeams': typing.Union[FlattenTeamsSchema, bool, ],
        'includeOrgUsers': typing.Union[IncludeOrgUsersSchema, bool, ],
    },
    total=False
)
...
request_query_flatten_teams = api_client.QueryParameter(
    name="flattenTeams",
    style=api_client.ParameterStyle.FORM,
    schema=FlattenTeamsSchema,
    explode=True,
)
request_query_include_org_users = api_client.QueryParameter(
    name="includeOrgUsers",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeOrgUsersSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiAppUserView
...
class BaseApi(api_client.Api):
    ...
    def _list_project_users_oapg(
        ...
        for parameter in (
            ...
            request_query_flatten_teams,
            request_query_include_org_users,
        ):
...
class ListProjectUsers(BaseApi):
    ...
    def list_project_users(
        ...
        return self._list_project_users_oapg(
