...
class TypeSchema(
    ...
    @schemas.classproperty
    def ONLINE_ARCHIVE(cls):
        return cls("ONLINE_ARCHIVE")
...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DataLakeTenant']:
            return DataLakeTenant

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DataLakeTenant'], typing.List['DataLakeTenant']],
    ...
    def __getitem__(self, i: int) -> 'DataLakeTenant':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_federated_databases_oapg(
        self,
...
class ListFederatedDatabases(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_federated_databases(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_federated_databases(
        ...
        return self._list_federated_databases_oapg(
