...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiTeamView


request_body_api_team_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiTeamResponseView
...
class BaseApi(api_client.Api):
    ...
    def _rename_team_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_team_view.serialize(body, content_type)
