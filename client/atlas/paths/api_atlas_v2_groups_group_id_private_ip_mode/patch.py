...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = PrivateIPModeView


request_body_private_ip_mode_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PrivateIPModeView
...
class BaseApi(api_client.Api):
    ...
    def _disable_peering_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_private_ip_mode_view.serialize(body, content_type)
...
class DisablePeering(BaseApi):
    ...
    def disable_peering(
        ...
        return self._disable_peering_oapg(
            body=body,
