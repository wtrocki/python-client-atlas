...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = OrgFederationSettingsView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_federation_settings_oapg(
        self,
...
class GetFederationSettings(BaseApi):
    ...
    def get_federation_settings(
        ...
        return self._get_federation_settings_oapg(
