...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'cloudProvider': typing.Union[CloudProviderSchema, str, ],
        'endpointServiceId': typing.Union[EndpointServiceIdSchema, str, ],
    }
)
...
request_path_cloud_provider = api_client.PathParameter(
    name="cloudProvider",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CloudProviderSchema,
    required=True,
)
request_path_endpoint_service_id = api_client.PathParameter(
    name="endpointServiceId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EndpointServiceIdSchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = Endpoint
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_private_endpoint_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,dict, frozendict.frozendict, ],
    ...
    def _create_private_endpoint_oapg(
        ...
        for parameter in (
            ...
            request_path_cloud_provider,
            request_path_endpoint_service_id,
        ):
...
class CreatePrivateEndpoint(BaseApi):
    ...
    def create_private_endpoint(
        ...
        return self._create_private_endpoint_oapg(
            body=body,
