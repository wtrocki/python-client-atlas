...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiAtlasDatabaseUserView
...
class ListDatabaseUsers(BaseApi):
    ...
    def list_database_users(
        ...
        return self._list_database_users_oapg(
