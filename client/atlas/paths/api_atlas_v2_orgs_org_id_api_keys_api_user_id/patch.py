...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiApiUserView


request_body_api_api_user_view = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_api_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_api_user_view.serialize(body, content_type)
