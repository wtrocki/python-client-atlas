...
# body param
SchemaForRequestBodyApplicationVndAtlas20230201json = ClusterDescriptionV15


request_body_cluster_description_v15 = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndAtlas20230201json = ClusterDescriptionV15
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-02-01+json': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationVndAtlas20230201json),
    },
)
...
SchemaFor402ResponseBodyApplicationJson = ApiError
...
class BaseApi(api_client.Api):
    ...
    def _create_cluster_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cluster_description_v15.serialize(body, content_type)
