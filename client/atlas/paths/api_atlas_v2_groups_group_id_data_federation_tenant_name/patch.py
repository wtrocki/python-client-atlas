...
SkipRoleValidationSchema = schemas.BoolSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'skipRoleValidation': typing.Union[SkipRoleValidationSchema, bool, ],
    }
)
...
request_query_skip_role_validation = api_client.QueryParameter(
    name="skipRoleValidation",
    style=api_client.ParameterStyle.FORM,
    schema=SkipRoleValidationSchema,
    required=True,
    explode=True,
)
# Path params
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DataLakeTenant


request_body_data_lake_tenant = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DataLakeTenant
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_federated_database_oapg(
        self,
    ...
    def _update_federated_database_oapg(
        ...
        for parameter in (
            ...
            request_query_skip_role_validation,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_data_lake_tenant.serialize(body, content_type)
...
class UpdateFederatedDatabase(BaseApi):
    ...
    def update_federated_database(
        ...
        return self._update_federated_database_oapg(
            body=body,
