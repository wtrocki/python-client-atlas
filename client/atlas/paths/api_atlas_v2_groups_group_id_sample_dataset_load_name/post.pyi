...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = SampleDatasetStatus


request_body_sample_dataset_status = api_client.RequestBody(
    content={
...
class SchemaFor201ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SampleDatasetStatus']:
            return SampleDatasetStatus

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SampleDatasetStatus'], typing.List['SampleDatasetStatus']],
    ...
    def __getitem__(self, i: int) -> 'SampleDatasetStatus':
...
class BaseApi(api_client.Api):
    ...
    def _load_sample_dataset_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sample_dataset_status.serialize(body, content_type)
...
class LoadSampleDataset(BaseApi):
    ...
    def load_sample_dataset(
        ...
        return self._load_sample_dataset_oapg(
            body=body,
