...
class SchemaForRequestBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiAddUserToTeamView']:
            return ApiAddUserToTeamView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ApiAddUserToTeamView'], typing.List['ApiAddUserToTeamView']],
    ...
    def __getitem__(self, i: int) -> 'ApiAddUserToTeamView':
        return super().__getitem__(i)


request_body_api_add_user_to_team_view = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_team_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_add_user_to_team_view.serialize(body, content_type)
...
class AddTeamUser(BaseApi):
    ...
    def add_team_user(
        ...
        return self._add_team_user_oapg(
            body=body,
