...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = GroupMaintenanceWindow
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_maintenance_window_oapg(
        self,
...
class GetMaintenanceWindow(BaseApi):
    ...
    def get_maintenance_window(
        ...
        return self._get_maintenance_window_oapg(
