...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = GroupMaintenanceWindow


request_body_group_maintenance_window = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_maintenance_window_oapg(
        self,
    ...
    def _update_maintenance_window_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_group_maintenance_window.serialize(body, content_type)
...
class UpdateMaintenanceWindow(BaseApi):
    ...
    def update_maintenance_window(
        ...
        return self._update_maintenance_window_oapg(
            body=body,
