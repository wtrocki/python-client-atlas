...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedUserCertView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_database_user_certificates_oapg(
        self,
...
class ListDatabaseUserCertificates(BaseApi):
    ...
    def list_database_user_certificates(
        ...
        return self._list_database_user_certificates_oapg(
