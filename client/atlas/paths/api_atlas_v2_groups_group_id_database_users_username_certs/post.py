...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = UserCert


request_body_user_cert = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = UserCert
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_database_user_certificate_oapg(
        self,
    ...
    def _create_database_user_certificate_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_cert.serialize(body, content_type)
...
class CreateDatabaseUserCertificate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_database_user_certificate(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_database_user_certificate(
        ...
        return self._create_database_user_certificate_oapg(
            body=body,
