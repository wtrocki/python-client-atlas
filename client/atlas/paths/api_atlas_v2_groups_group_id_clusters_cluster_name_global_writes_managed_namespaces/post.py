...
# body param
SchemaForRequestBodyApplicationVndAtlas20230201json = ManagedNamespaceView


request_body_managed_namespace_view = api_client.RequestBody(
    content={
        'application/vnd.atlas.2023-02-01+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndAtlas20230201json),
    },
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230201json = GeoSharding
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-02-01+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndAtlas20230201json),
    },
)
...
SchemaFor405ResponseBodyApplicationJson = ApiError
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_managed_namespace_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230201json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-02-01+json"] = ...,
    ...
    def _create_managed_namespace_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230201json,],
        content_type: str = 'application/vnd.atlas.2023-02-01+json',
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_managed_namespace_view.serialize(body, content_type)
...
class CreateManagedNamespace(BaseApi):
    ...
    def create_managed_namespace(
        ...
        return self._create_managed_namespace_oapg(
            body=body,
