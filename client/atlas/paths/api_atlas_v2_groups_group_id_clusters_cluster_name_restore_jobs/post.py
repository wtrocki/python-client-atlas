...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiRestoreJobView


request_body_api_restore_job_view = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_legacy_backup_restore_job_oapg(
        self,
    ...
    def _create_legacy_backup_restore_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_restore_job_view.serialize(body, content_type)
...
class CreateLegacyBackupRestoreJob(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_legacy_backup_restore_job(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_legacy_backup_restore_job(
        ...
        return self._create_legacy_backup_restore_job_oapg(
            body=body,
