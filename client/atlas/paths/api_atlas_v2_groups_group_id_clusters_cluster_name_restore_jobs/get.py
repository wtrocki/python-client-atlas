...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedRestoreJobView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_legacy_backup_restore_jobs_oapg(
        self,
...
class ListLegacyBackupRestoreJobs(BaseApi):
    ...
    def list_legacy_backup_restore_jobs(
        ...
        return self._list_legacy_backup_restore_jobs_oapg(
