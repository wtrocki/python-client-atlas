...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiSystemStatusView
...
class GetSystemStatus(BaseApi):
    ...
    def get_system_status(
        ...
        return self._get_system_status_oapg(
