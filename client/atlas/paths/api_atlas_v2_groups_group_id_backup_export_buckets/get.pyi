...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedBackupSnapshotExportBucketView
...
class ListExportBuckets(BaseApi):
    ...
    def list_export_buckets(
        ...
        return self._list_export_buckets_oapg(
