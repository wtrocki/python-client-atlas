...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DiskBackupSnapshotAWSExportBucket


request_body_disk_backup_snapshot_aws_export_bucket = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DiskBackupSnapshotAWSExportBucket
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_export_bucket_oapg(
        self,
    ...
    def _create_export_bucket_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_disk_backup_snapshot_aws_export_bucket.serialize(body, content_type)
...
class CreateExportBucket(BaseApi):
    ...
    def create_export_bucket(
        ...
        return self._create_export_bucket_oapg(
            body=body,
