...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ServerlessInstanceDescription


request_body_serverless_instance_description = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upgrade_shared_cluster_to_serverless_oapg(
        self,
    ...
    def _upgrade_shared_cluster_to_serverless_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_serverless_instance_description.serialize(body, content_type)
...
class UpgradeSharedClusterToServerless(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def upgrade_shared_cluster_to_serverless(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def upgrade_shared_cluster_to_serverless(
        ...
        return self._upgrade_shared_cluster_to_serverless_oapg(
            body=body,
