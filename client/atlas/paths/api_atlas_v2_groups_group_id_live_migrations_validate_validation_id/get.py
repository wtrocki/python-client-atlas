...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'validationId': typing.Union[ValidationIdSchema, str, ],
    }
)
...
request_path_validation_id = api_client.PathParameter(
    name="validationId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ValidationIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_validation_status_oapg(
        self,
...
class GetValidationStatus(BaseApi):
    ...
    def get_validation_status(
        ...
        return self._get_validation_status_oapg(
