...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'archiveId': typing.Union[ArchiveIdSchema, str, ],
...
request_path_archive_id = api_client.PathParameter(
    name="archiveId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ArchiveIdSchema,
    required=True,
)
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = OnlineArchive


request_body_online_archive = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = OnlineArchive
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_online_archive_oapg(
        self,
    ...
    def _update_online_archive_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_online_archive.serialize(body, content_type)
...
class UpdateOnlineArchive(BaseApi):
    ...
    def update_online_archive(
        ...
        return self._update_online_archive_oapg(
            body=body,
