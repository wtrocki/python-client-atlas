...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = CreateEndpointServiceRequest


request_body_create_endpoint_service_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_private_endpoint_service_oapg(
        self,
    ...
    def _create_private_endpoint_service_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_endpoint_service_request.serialize(body, content_type)
...
class CreatePrivateEndpointService(BaseApi):
    ...
    def create_private_endpoint_service(
        ...
        return self._create_private_endpoint_service_oapg(
            body=body,
