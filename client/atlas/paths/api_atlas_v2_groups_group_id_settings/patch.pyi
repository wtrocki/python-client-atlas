...
# body param
SchemaForRequestBodyApplicationJson = GroupSettings


request_body_group_settings = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = GroupSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_project_settings_oapg(
        self,
    ...
    def _update_project_settings_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_group_settings.serialize(body, content_type)
...
class UpdateProjectSettings(BaseApi):
    ...
    def update_project_settings(
        ...
        return self._update_project_settings_oapg(
            body=body,
