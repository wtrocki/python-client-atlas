...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = AWSCustomDNSEnabledView


request_body_aws_custom_dns_enabled_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = AWSCustomDNSEnabledView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _toggle_aws_custom_dns_oapg(
        self,
    ...
    def _toggle_aws_custom_dns_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_aws_custom_dns_enabled_view.serialize(body, content_type)
...
class ToggleAwsCustomDns(BaseApi):
    ...
    def toggle_aws_custom_dns(
        ...
        return self._toggle_aws_custom_dns_oapg(
            body=body,
