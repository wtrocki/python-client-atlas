...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = TenantSnapshot
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_shared_cluster_backup_oapg(
        self,
...
class GetSharedClusterBackup(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_shared_cluster_backup(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_shared_cluster_backup(
        ...
        return self._get_shared_cluster_backup_oapg(
