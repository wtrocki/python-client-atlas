...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = PrivateNetworkEndpointIdEntry


request_body_private_network_endpoint_id_entry = api_client.RequestBody(
    content={
...
class SchemaFor201ResponseBodyApplicationVndAtlas20230101json(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PrivateNetworkEndpointIdEntry']:
            return PrivateNetworkEndpointIdEntry

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PrivateNetworkEndpointIdEntry'], typing.List['PrivateNetworkEndpointIdEntry']],
    ...
    def __getitem__(self, i: int) -> 'PrivateNetworkEndpointIdEntry':
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-01-01+json': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationVndAtlas20230101json),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_data_federation_private_endpoint_oapg(
        self,
    ...
    def _create_data_federation_private_endpoint_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_private_network_endpoint_id_entry.serialize(body, content_type)
...
class CreateDataFederationPrivateEndpoint(BaseApi):
    ...
    def create_data_federation_private_endpoint(
        ...
        return self._create_data_federation_private_endpoint_oapg(
            body=body,
