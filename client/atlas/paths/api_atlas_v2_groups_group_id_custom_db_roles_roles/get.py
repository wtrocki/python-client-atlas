...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CustomDBRole']:
            return CustomDBRole

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CustomDBRole'], typing.List['CustomDBRole']],
    ...
    def __getitem__(self, i: int) -> 'CustomDBRole':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_custom_database_roles_oapg(
        self,
...
class ListCustomDatabaseRoles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_custom_database_roles(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_custom_database_roles(
        ...
        return self._list_custom_database_roles_oapg(
