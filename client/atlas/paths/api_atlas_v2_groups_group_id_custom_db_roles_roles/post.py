...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = CustomDBRole


request_body_custom_db_role = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationVndAtlas20230101json = CustomDBRole
...
_response_for_202 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-01-01+json': api_client.MediaType(
            schema=SchemaFor202ResponseBodyApplicationVndAtlas20230101json),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_custom_database_role_oapg(
        self,
    ...
    def _create_custom_database_role_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_custom_db_role.serialize(body, content_type)
...
class CreateCustomDatabaseRole(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_custom_database_role(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_custom_database_role(
        ...
        return self._create_custom_database_role_oapg(
            body=body,
