...
class EndDateSchema(
    ...
    class MetaOapg:
        format = 'int64'
        inclusive_minimum = 1199145600
ArchiveOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'archiveOnly': typing.Union[ArchiveOnlySchema, bool, ],
    },
    total=False
)
...
request_query_archive_only = api_client.QueryParameter(
    name="archiveOnly",
    style=api_client.ParameterStyle.FORM,
    schema=ArchiveOnlySchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101gzip = schemas.BinarySchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-01-01+gzip': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndAtlas20230101gzip),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_online_archive_query_logs_oapg(
        self,
...
class DownloadOnlineArchiveQueryLogs(BaseApi):
    ...
    def download_online_archive_query_logs(
        ...
        return self._download_online_archive_query_logs_oapg(
