...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'peerId': typing.Union[PeerIdSchema, str, ],
    }
)
...
request_path_peer_id = api_client.PathParameter(
    name="peerId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PeerIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiAtlasContainerPeerViewRequest


request_body_api_atlas_container_peer_view_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_peering_connection_oapg(
        self,
    ...
    def _update_peering_connection_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_atlas_container_peer_view_request.serialize(body, content_type)
...
class UpdatePeeringConnection(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_peering_connection(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_peering_connection(
        ...
        return self._update_peering_connection_oapg(
            body=body,
