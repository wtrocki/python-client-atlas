...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'indexId': typing.Union[IndexIdSchema, str, ],
    }
)
...
request_path_index_id = api_client.PathParameter(
    name="indexId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=IndexIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = FTSIndex


request_body_fts_index = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = FTSIndex
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_atlas_search_index_oapg(
        self,
    ...
    def _update_atlas_search_index_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_fts_index.serialize(body, content_type)
...
class UpdateAtlasSearchIndex(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_atlas_search_index(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_atlas_search_index(
        ...
        return self._update_atlas_search_index_oapg(
            body=body,
