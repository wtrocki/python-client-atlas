...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DiskBackupRestoreJob


request_body_disk_backup_restore_job = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DiskBackupRestoreJob
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_backup_restore_job_oapg(
        self,
    ...
    def _create_backup_restore_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_disk_backup_restore_job.serialize(body, content_type)
...
class CreateBackupRestoreJob(BaseApi):
    ...
    def create_backup_restore_job(
        ...
        return self._create_backup_restore_job_oapg(
            body=body,
