...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedCloudBackupRestoreJobView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_backup_restore_jobs_oapg(
        self,
...
class ListBackupRestoreJobs(BaseApi):
    ...
    def list_backup_restore_jobs(
        ...
        return self._list_backup_restore_jobs_oapg(
