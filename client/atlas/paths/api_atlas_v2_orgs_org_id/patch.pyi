...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiOrganizationView


request_body_api_organization_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiOrganizationView
...
class BaseApi(api_client.Api):
    ...
    def _rename_organization_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_organization_view.serialize(body, content_type)
