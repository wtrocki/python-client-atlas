...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = EventViewForOrg
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_event_oapg(
        self,
...
class GetOrganizationEvent(BaseApi):
    ...
    def get_organization_event(
        ...
        return self._get_organization_event_oapg(
