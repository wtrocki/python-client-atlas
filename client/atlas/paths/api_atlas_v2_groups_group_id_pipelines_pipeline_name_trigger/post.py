...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = TriggerIngestionRequest


request_body_trigger_ingestion_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = IngestionPipelineRun
...
class BaseApi(api_client.Api):
    @typing.overload
    def _trigger_snapshot_ingestion_oapg(
        self,
    ...
    def _trigger_snapshot_ingestion_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_trigger_ingestion_request.serialize(body, content_type)
...
class TriggerSnapshotIngestion(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def trigger_snapshot_ingestion(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def trigger_snapshot_ingestion(
        ...
        return self._trigger_snapshot_ingestion_oapg(
            body=body,
