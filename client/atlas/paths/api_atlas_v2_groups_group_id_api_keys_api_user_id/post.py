...
class SchemaForRequestBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiUserRoleAssignment']:
            return ApiUserRoleAssignment

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ApiUserRoleAssignment'], typing.List['ApiUserRoleAssignment']],
    ...
    def __getitem__(self, i: int) -> 'ApiUserRoleAssignment':
        return super().__getitem__(i)


request_body_api_user_role_assignment = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_project_api_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_user_role_assignment.serialize(body, content_type)
...
class AddProjectApiKey(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_project_api_key(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,list, tuple, ],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def add_project_api_key(
        ...
        return self._add_project_api_key_oapg(
            body=body,
