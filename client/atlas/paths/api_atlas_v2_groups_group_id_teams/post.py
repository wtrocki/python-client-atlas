...
class SchemaForRequestBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiTeamRoleView']:
            return ApiTeamRoleView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ApiTeamRoleView'], typing.List['ApiTeamRoleView']],
    ...
    def __getitem__(self, i: int) -> 'ApiTeamRoleView':
        return super().__getitem__(i)


request_body_api_team_role_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedTeamRoleView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_all_teams_to_project_oapg(
        self,
    ...
    def _add_all_teams_to_project_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_team_role_view.serialize(body, content_type)
...
class AddAllTeamsToProject(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_all_teams_to_project(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,list, tuple, ],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def add_all_teams_to_project(
        ...
        return self._add_all_teams_to_project_oapg(
            body=body,
