...
class MSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "DATABASE_AVERAGE_OBJECT_SIZE": "AVERAGE_OBJECT_SIZE",
                    "DATABASE_COLLECTION_COUNT": "COLLECTION_COUNT",
                    "DATABASE_DATA_SIZE": "DATA_SIZE",
                    "DATABASE_STORAGE_SIZE": "STORAGE_SIZE",
                    "DATABASE_INDEX_SIZE": "INDEX_SIZE",
                    "DATABASE_INDEX_COUNT": "INDEX_COUNT",
                    "DATABASE_EXTENT_COUNT": "EXTENT_COUNT",
                    "DATABASE_OBJECT_COUNT": "OBJECT_COUNT",
                    "DATABASE_VIEW_COUNT": "VIEW_COUNT",
                }
            
            @schemas.classproperty
            def AVERAGE_OBJECT_SIZE(cls):
                return cls("DATABASE_AVERAGE_OBJECT_SIZE")
            
            @schemas.classproperty
            def COLLECTION_COUNT(cls):
                return cls("DATABASE_COLLECTION_COUNT")
            
            @schemas.classproperty
            def DATA_SIZE(cls):
                return cls("DATABASE_DATA_SIZE")
            
            @schemas.classproperty
            def STORAGE_SIZE(cls):
                return cls("DATABASE_STORAGE_SIZE")
            
            @schemas.classproperty
            def INDEX_SIZE(cls):
                return cls("DATABASE_INDEX_SIZE")
            
            @schemas.classproperty
            def INDEX_COUNT(cls):
                return cls("DATABASE_INDEX_COUNT")
            
            @schemas.classproperty
            def EXTENT_COUNT(cls):
                return cls("DATABASE_EXTENT_COUNT")
            
            @schemas.classproperty
            def OBJECT_COUNT(cls):
                return cls("DATABASE_OBJECT_COUNT")
            
            @schemas.classproperty
            def VIEW_COUNT(cls):
                return cls("DATABASE_VIEW_COUNT")
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_database_measurements_oapg(
        self,
...
class GetDatabaseMeasurements(BaseApi):
    ...
    def get_database_measurements(
        ...
        return self._get_database_measurements_oapg(
