...
# body param
SchemaForRequestBodyApplicationJson = ApiLimitView


request_body_api_limit_view = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiLimitView
...
class BaseApi(api_client.Api):
    ...
    def _set_project_limit_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_api_limit_view.serialize(body, content_type)
...
class SetProjectLimit(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def set_project_limit(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def set_project_limit(
        ...
        return self._set_project_limit_oapg(
            body=body,
