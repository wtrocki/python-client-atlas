...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ClusterOutageSimulation


request_body_cluster_outage_simulation = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ClusterOutageSimulation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _start_outage_simulation_oapg(
        self,
    ...
    def _start_outage_simulation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cluster_outage_simulation.serialize(body, content_type)
...
class StartOutageSimulation(BaseApi):
    ...
    def start_outage_simulation(
        ...
        return self._start_outage_simulation_oapg(
            body=body,
