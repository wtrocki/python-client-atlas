...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiApiUserView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_project_api_keys_oapg(
        self,
...
class ListProjectApiKeys(BaseApi):
    ...
    def list_project_api_keys(
        ...
        return self._list_project_api_keys_oapg(
