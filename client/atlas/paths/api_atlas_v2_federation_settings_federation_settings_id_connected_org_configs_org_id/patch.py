...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ConnectedOrgConfigView


request_body_connected_org_config_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ConnectedOrgConfigView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_connected_org_config_oapg(
        self,
    ...
    def _update_connected_org_config_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_connected_org_config_view.serialize(body, content_type)
...
class UpdateConnectedOrgConfig(BaseApi):
    ...
    def update_connected_org_config(
        ...
        return self._update_connected_org_config_oapg(
            body=body,
