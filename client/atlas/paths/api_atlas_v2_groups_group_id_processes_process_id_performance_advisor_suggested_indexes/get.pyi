...
NExamplesSchema = schemas.Int64Schema
NIndexesSchema = schemas.Int64Schema
SinceSchema = schemas.NumberSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'namespaces': typing.Union[NamespacesSchema, list, tuple, ],
        'nExamples': typing.Union[NExamplesSchema, decimal.Decimal, int, ],
        'nIndexes': typing.Union[NIndexesSchema, decimal.Decimal, int, ],
        'since': typing.Union[SinceSchema, decimal.Decimal, int, float, ],
    },
    total=False
)
...
request_query_namespaces = api_client.QueryParameter(
    name="namespaces",
    style=api_client.ParameterStyle.FORM,
    schema=NamespacesSchema,
    explode=True,
)
request_query_n_examples = api_client.QueryParameter(
    name="nExamples",
    style=api_client.ParameterStyle.FORM,
    schema=NExamplesSchema,
    explode=True,
)
request_query_n_indexes = api_client.QueryParameter(
    name="nIndexes",
    style=api_client.ParameterStyle.FORM,
    schema=NIndexesSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiPerformanceAdvisorResponseView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_suggested_indexes_oapg(
        self,
    ...
    def _list_suggested_indexes_oapg(
        ...
        for parameter in (
            ...
            request_query_namespaces,
            request_query_n_examples,
            request_query_n_indexes,
            request_query_since,
        ):
...
class ListSuggestedIndexes(BaseApi):
    ...
    def list_suggested_indexes(
        ...
        return self._list_suggested_indexes_oapg(
