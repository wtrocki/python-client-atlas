...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = NDSLDAPVerifyConnectivityJobRequestParams


request_body_ndsldap_verify_connectivity_job_request_params = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = NDSLDAPVerifyConnectivityJobRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _verify_ldap_configuration_oapg(
        self,
    ...
    def _verify_ldap_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ndsldap_verify_connectivity_job_request_params.serialize(body, content_type)
...
class VerifyLdapConfiguration(BaseApi):
    ...
    def verify_ldap_configuration(
        ...
        return self._verify_ldap_configuration_oapg(
            body=body,
