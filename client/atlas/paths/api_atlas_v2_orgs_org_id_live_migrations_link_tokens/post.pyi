...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = TargetOrgRequestView


request_body_target_org_request_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = TargetOrgView
...
class BaseApi(api_client.Api):
    ...
    def _create_link_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_target_org_request_view.serialize(body, content_type)
...
class CreateLinkToken(BaseApi):
    ...
    def create_link_token(
        ...
        return self._create_link_token_oapg(
            body=body,
