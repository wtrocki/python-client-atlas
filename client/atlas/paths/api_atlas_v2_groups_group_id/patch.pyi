...
# body param
SchemaForRequestBodyApplicationJson = GroupName


request_body_group_name = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_project_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_group_name.serialize(body, content_type)
