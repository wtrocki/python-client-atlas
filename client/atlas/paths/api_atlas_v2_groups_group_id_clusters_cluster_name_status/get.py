...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ClusterStatus
...
class GetClusterStatus(BaseApi):
    ...
    def get_cluster_status(
        ...
        return self._get_cluster_status_oapg(
