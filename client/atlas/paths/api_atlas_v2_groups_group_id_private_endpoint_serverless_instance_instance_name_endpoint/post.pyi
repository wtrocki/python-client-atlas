...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'instanceName': typing.Union[InstanceNameSchema, str, ],
    }
)
...
request_path_instance_name = api_client.PathParameter(
    name="instanceName",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ServerlessTenantEndpointCreate


request_body_serverless_tenant_endpoint_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndAtlas20230101json = ServerlessTenantEndpoint
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_serverless_private_endpoint_oapg(
        self,
    ...
    def _create_serverless_private_endpoint_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_serverless_tenant_endpoint_create.serialize(body, content_type)
...
class CreateServerlessPrivateEndpoint(BaseApi):
    ...
    def create_serverless_private_endpoint(
        ...
        return self._create_serverless_private_endpoint_oapg(
            body=body,
