...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ServerlessTenantEndpoint']:
            return ServerlessTenantEndpoint

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ServerlessTenantEndpoint'], typing.List['ServerlessTenantEndpoint']],
    ...
    def __getitem__(self, i: int) -> 'ServerlessTenantEndpoint':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_serverless_private_endpoints_oapg(
        self,
...
class ListServerlessPrivateEndpoints(BaseApi):
    ...
    def list_serverless_private_endpoints(
        ...
        return self._list_serverless_private_endpoints_oapg(
