...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_data_federation_private_endpoint_oapg(
        self,
...
class DeleteDataFederationPrivateEndpoint(BaseApi):
    ...
    def delete_data_federation_private_endpoint(
        ...
        return self._delete_data_federation_private_endpoint_oapg(
