...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PrivateNetworkEndpointIdEntry
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_data_federation_private_endpoint_oapg(
        self,
...
class GetDataFederationPrivateEndpoint(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_data_federation_private_endpoint(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_data_federation_private_endpoint(
        ...
        return self._get_data_federation_private_endpoint_oapg(
