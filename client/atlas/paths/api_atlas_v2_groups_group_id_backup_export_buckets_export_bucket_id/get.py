...
class ExportBucketIdSchema(
    ...
    class MetaOapg:
        ...
        min_length = 3
        regex=[{
            'pattern': r'^((?!xn--)(?!.*-s3alias)[a-z0-9][a-z0-9-]{1,61}[a-z0-9])$',  # noqa: E501
        }]
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'groupId': typing.Union[GroupIdSchema, str, ],
        'exportBucketId': typing.Union[ExportBucketIdSchema, str, ],
    }
)
...
request_path_export_bucket_id = api_client.PathParameter(
    name="exportBucketId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ExportBucketIdSchema,
    required=True,
)
...
class GetExportBucket(BaseApi):
    ...
    def get_export_bucket(
        ...
        return self._get_export_bucket_oapg(
