...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DiskBackupOnDemandSnapshotRequest


request_body_disk_backup_on_demand_snapshot_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DiskBackupSnapshot
...
class BaseApi(api_client.Api):
    ...
    def _take_snapshot_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_disk_backup_on_demand_snapshot_request.serialize(body, content_type)
...
class TakeSnapshot(BaseApi):
    ...
    def take_snapshot(
        ...
        return self._take_snapshot_oapg(
            body=body,
