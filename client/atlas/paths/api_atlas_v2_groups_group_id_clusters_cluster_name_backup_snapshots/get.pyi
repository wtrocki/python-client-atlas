...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedCloudBackupReplicaSetView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_replica_set_backups_oapg(
        self,
...
class ListReplicaSetBackups(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_replica_set_backups(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_replica_set_backups(
        ...
        return self._list_replica_set_backups_oapg(
