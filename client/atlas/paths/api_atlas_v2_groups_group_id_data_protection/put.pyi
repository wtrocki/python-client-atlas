...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DataProtectionSettings


request_body_data_protection_settings = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DataProtectionSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_data_protection_settings_oapg(
        self,
    ...
    def _update_data_protection_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_data_protection_settings.serialize(body, content_type)
...
class UpdateDataProtectionSettings(BaseApi):
    ...
    def update_data_protection_settings(
        ...
        return self._update_data_protection_settings_oapg(
            body=body,
