...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = TenantRestore


request_body_tenant_restore = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = TenantRestore
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_shared_cluster_backup_restore_job_oapg(
        self,
    ...
    def _create_shared_cluster_backup_restore_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tenant_restore.serialize(body, content_type)
...
class CreateSharedClusterBackupRestoreJob(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_shared_cluster_backup_restore_job(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_shared_cluster_backup_restore_job(
        ...
        return self._create_shared_cluster_backup_restore_job_oapg(
            body=body,
