...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DatabaseUser


request_body_database_user = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DatabaseUser
...
class BaseApi(api_client.Api):
    ...
    def _update_database_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_database_user.serialize(body, content_type)
