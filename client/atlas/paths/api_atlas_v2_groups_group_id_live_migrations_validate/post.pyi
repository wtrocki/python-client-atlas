...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ValidationView
...
class ValidateMigration(BaseApi):
    ...
    def validate_migration(
        ...
        return self._validate_migration_oapg(
            body=body,
