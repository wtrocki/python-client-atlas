...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'pipelineRunId': typing.Union[PipelineRunIdSchema, str, ],
    }
)
...
request_path_pipeline_run_id = api_client.PathParameter(
    name="pipelineRunId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PipelineRunIdSchema,
    required=True,
)
...
class GetPipelineRun(BaseApi):
    ...
    def get_pipeline_run(
        ...
        return self._get_pipeline_run_oapg(
