...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'snapshotId': typing.Union[SnapshotIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiSnapshotView


request_body_api_snapshot_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiSnapshotView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_legacy_snapshot_retention_oapg(
        self,
    ...
    def _update_legacy_snapshot_retention_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_snapshot_view.serialize(body, content_type)
...
class UpdateLegacySnapshotRetention(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_legacy_snapshot_retention(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_legacy_snapshot_retention(
        ...
        return self._update_legacy_snapshot_retention_oapg(
            body=body,
