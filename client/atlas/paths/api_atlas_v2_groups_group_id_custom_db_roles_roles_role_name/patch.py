...
class RoleNameSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^\b(?!xgen-)([0-9A-Za-z_\-]+)\b(?<!\atlasAdmin|read|readWrite|dbAdmin|dbOwner|userAdmin|clusterAdmin|clusterManager|clusterMonitor|hostManager|backup|restore|readAnyDatabase|readWriteAnyDatabase|userAdminAnyDatabase|dbAdminAnyDatabase|root|__system)$',  # noqa: E501
        }]
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'groupId': typing.Union[GroupIdSchema, str, ],
        'roleName': typing.Union[RoleNameSchema, str, ],
    }
)
...
request_path_role_name = api_client.PathParameter(
    name="roleName",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = UpdateCustomDBRole


request_body_update_custom_db_role = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = CustomDBRole
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_custom_database_role_oapg(
        self,
    ...
    def _update_custom_database_role_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_custom_db_role.serialize(body, content_type)
...
class UpdateCustomDatabaseRole(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_custom_database_role(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_custom_database_role(
        ...
        return self._update_custom_database_role_oapg(
            body=body,
