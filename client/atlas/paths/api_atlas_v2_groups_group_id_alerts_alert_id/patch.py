...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = AlertViewForNdsGroup


request_body_alert_view_for_nds_group = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = AlertViewForNdsGroup
...
class BaseApi(api_client.Api):
    ...
    def _acknowledge_alert_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alert_view_for_nds_group.serialize(body, content_type)
...
class AcknowledgeAlert(BaseApi):
    ...
    def acknowledge_alert(
        ...
        return self._acknowledge_alert_oapg(
            body=body,
