...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiOrganizationInvitationView']:
            return ApiOrganizationInvitationView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ApiOrganizationInvitationView'], typing.List['ApiOrganizationInvitationView']],
    ...
    def __getitem__(self, i: int) -> 'ApiOrganizationInvitationView':
