...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = EndpointService
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_private_endpoint_service_oapg(
        self,
...
class GetPrivateEndpointService(BaseApi):
    ...
    def get_private_endpoint_service(
        ...
        return self._get_private_endpoint_service_oapg(
