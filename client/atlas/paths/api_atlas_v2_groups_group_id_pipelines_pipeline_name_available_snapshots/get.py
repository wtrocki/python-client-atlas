...
CompletedAfterSchema = schemas.DateTimeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'completedAfter': typing.Union[CompletedAfterSchema, str, datetime, ],
    },
    total=False
)
...
request_query_completed_after = api_client.QueryParameter(
    name="completedAfter",
    style=api_client.ParameterStyle.FORM,
    schema=CompletedAfterSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedBackupSnapshotView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_pipeline_snapshots_oapg(
        self,
...
class ListPipelineSnapshots(BaseApi):
    ...
    def list_pipeline_snapshots(
        ...
        return self._list_pipeline_snapshots_oapg(
