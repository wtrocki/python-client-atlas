...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'liveMigrationId': typing.Union[LiveMigrationIdSchema, str, ],
    }
)
...
request_path_live_migration_id = api_client.PathParameter(
    name="liveMigrationId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LiveMigrationIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = LiveMigrationResponseView
...
class BaseApi(api_client.Api):
    ...
    def _get_push_migration_oapg(
        ...
        for parameter in (
            ...
            request_path_live_migration_id,
        ):
...
class GetPushMigration(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_push_migration(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_push_migration(
        ...
        return self._get_push_migration_oapg(
