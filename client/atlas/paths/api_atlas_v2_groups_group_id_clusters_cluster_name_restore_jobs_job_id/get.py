...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiRestoreJobView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_legacy_backup_restore_job_oapg(
        self,
...
class GetLegacyBackupRestoreJob(BaseApi):
    ...
    def get_legacy_backup_restore_job(
        ...
        return self._get_legacy_backup_restore_job_oapg(
