...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiNamespacesView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_slow_query_namespaces_oapg(
        self,
...
class ListSlowQueryNamespaces(BaseApi):
    ...
    def list_slow_query_namespaces(
        ...
        return self._list_slow_query_namespaces_oapg(
