...
class SchemaForRequestBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['NetworkPermissionEntry']:
            return NetworkPermissionEntry

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['NetworkPermissionEntry'], typing.List['NetworkPermissionEntry']],
    ...
    def __getitem__(self, i: int) -> 'NetworkPermissionEntry':
        return super().__getitem__(i)


request_body_network_permission_entry = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedNetworkAccessView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_ip_access_list_oapg(
        self,
    ...
    def _create_project_ip_access_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_network_permission_entry.serialize(body, content_type)
...
class CreateProjectIpAccessList(BaseApi):
    ...
    def create_project_ip_access_list(
        ...
        return self._create_project_ip_access_list_oapg(
            body=body,
