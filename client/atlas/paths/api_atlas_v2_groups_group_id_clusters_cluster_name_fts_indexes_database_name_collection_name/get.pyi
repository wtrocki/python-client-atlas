...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FTSIndex']:
            return FTSIndex

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['FTSIndex'], typing.List['FTSIndex']],
    ...
    def __getitem__(self, i: int) -> 'FTSIndex':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_atlas_search_indexes_oapg(
        self,
...
class ListAtlasSearchIndexes(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_atlas_search_indexes(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_atlas_search_indexes(
        ...
        return self._list_atlas_search_indexes_oapg(
