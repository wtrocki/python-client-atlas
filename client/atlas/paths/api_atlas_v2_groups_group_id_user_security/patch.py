...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = UserSecurity


request_body_user_security = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = UserSecurity
...
class BaseApi(api_client.Api):
    @typing.overload
    def _save_ldap_configuration_oapg(
        self,
    ...
    def _save_ldap_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_security.serialize(body, content_type)
...
class SaveLdapConfiguration(BaseApi):
    ...
    def save_ldap_configuration(
        ...
        return self._save_ldap_configuration_oapg(
            body=body,
