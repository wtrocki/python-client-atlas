...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedPrivateLinkConnectionView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_private_endpoint_services_oapg(
        self,
...
class ListPrivateEndpointServices(BaseApi):
    ...
    def list_private_endpoint_services(
        ...
        return self._list_private_endpoint_services_oapg(
