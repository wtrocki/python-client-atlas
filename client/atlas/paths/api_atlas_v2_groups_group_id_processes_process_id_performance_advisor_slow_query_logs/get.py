...
DurationSchema = schemas.Int64Schema
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiPerformanceAdvisorSlowQueryListView
...
class ListSlowQueries(BaseApi):
    ...
    def list_slow_queries(
        ...
        return self._list_slow_queries_oapg(
