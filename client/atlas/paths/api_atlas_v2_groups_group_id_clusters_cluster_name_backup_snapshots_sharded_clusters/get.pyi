...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedCloudBackupShardedClusterSnapshotView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_sharded_cluster_backups_oapg(
        self,
...
class ListShardedClusterBackups(BaseApi):
    ...
    def list_sharded_cluster_backups(
        ...
        return self._list_sharded_cluster_backups_oapg(
