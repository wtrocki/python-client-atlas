...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = AlertConfigViewForNdsGroup


request_body_alert_config_view_for_nds_group = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = AlertConfigViewForNdsGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_alert_configuration_oapg(
        self,
    ...
    def _update_alert_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_alert_config_view_for_nds_group.serialize(body, content_type)
...
class UpdateAlertConfiguration(BaseApi):
    ...
    def update_alert_configuration(
        ...
        return self._update_alert_configuration_oapg(
            body=body,
