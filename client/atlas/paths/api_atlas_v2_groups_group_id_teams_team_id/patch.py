...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiTeamRoleView
...
class UpdateTeamRoles(BaseApi):
    ...
    def update_team_roles(
        ...
        return self._update_team_roles_oapg(
            body=body,
