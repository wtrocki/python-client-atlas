...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'alertId': typing.Union[AlertIdSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedAlertConfigView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_alert_configurations_by_alert_id_oapg(
        self,
...
class ListAlertConfigurationsByAlertId(BaseApi):
    ...
    def list_alert_configurations_by_alert_id(
        ...
        return self._list_alert_configurations_by_alert_id_oapg(
