...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiGroupInvitationUpdateRequestView


request_body_api_group_invitation_update_request_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiGroupInvitationView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_project_invitation_by_id_oapg(
        self,
    ...
    def _update_project_invitation_by_id_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_group_invitation_update_request_view.serialize(body, content_type)
...
class UpdateProjectInvitationById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_project_invitation_by_id(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_project_invitation_by_id(
        ...
        return self._update_project_invitation_by_id_oapg(
            body=body,
