...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MatcherFieldView']:
            return MatcherFieldView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['MatcherFieldView'], typing.List['MatcherFieldView']],
    ...
    def __getitem__(self, i: int) -> 'MatcherFieldView':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_alert_configuration_matchers_field_names_oapg(
        self,
...
class ListAlertConfigurationMatchersFieldNames(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_alert_configuration_matchers_field_names(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_alert_configuration_matchers_field_names(
        ...
        return self._list_alert_configuration_matchers_field_names_oapg(
