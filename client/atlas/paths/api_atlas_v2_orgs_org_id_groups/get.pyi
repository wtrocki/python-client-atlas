...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedAtlasGroupView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_organization_projects_oapg(
        self,
...
class ListOrganizationProjects(BaseApi):
    ...
    def list_organization_projects(
        ...
        return self._list_organization_projects_oapg(
