...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['IdentityProviderView']:
            return IdentityProviderView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['IdentityProviderView'], typing.List['IdentityProviderView']],
    ...
    def __getitem__(self, i: int) -> 'IdentityProviderView':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_identity_providers_oapg(
        self,
...
class ListIdentityProviders(BaseApi):
    ...
    def list_identity_providers(
        ...
        return self._list_identity_providers_oapg(
