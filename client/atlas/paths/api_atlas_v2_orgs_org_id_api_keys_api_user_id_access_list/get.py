...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiUserAccessListView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_api_key_access_lists_entries_oapg(
        self,
...
class ListApiKeyAccessListsEntries(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_api_key_access_lists_entries(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_api_key_access_lists_entries(
        ...
        return self._list_api_key_access_lists_entries_oapg(
