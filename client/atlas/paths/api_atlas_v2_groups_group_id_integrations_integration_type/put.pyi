...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = IntegrationViewForNdsGroup


request_body_integration_view_for_nds_group = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = GroupPaginatedIntegrationView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_third_party_integration_oapg(
        self,
    ...
    def _update_third_party_integration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_integration_view_for_nds_group.serialize(body, content_type)
...
class UpdateThirdPartyIntegration(BaseApi):
    ...
    def update_third_party_integration(
        ...
        return self._update_third_party_integration_oapg(
            body=body,
