...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = IntegrationViewForNdsGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_third_party_integration_oapg(
        self,
...
class GetThirdPartyIntegration(BaseApi):
    ...
    def get_third_party_integration(
        ...
        return self._get_third_party_integration_oapg(
