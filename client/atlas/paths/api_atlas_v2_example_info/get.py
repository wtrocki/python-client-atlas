...
AdditionalInfoSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'additionalInfo': typing.Union[AdditionalInfoSchema, bool, ],
    },
    total=False
)
...
request_query_additional_info = api_client.QueryParameter(
    name="additionalInfo",
    style=api_client.ParameterStyle.FORM,
    schema=AdditionalInfoSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230201json = ExampleResourceResponseView20230201
...
class VersionedExample(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def versioned_example(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def versioned_example(
        ...
        return self._versioned_example_oapg(
