...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = LiveMigrationRequestView


request_body_live_migration_request_view = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndAtlas20230101json = LiveMigrationResponseView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_push_migration_oapg(
        self,
    ...
    def _create_push_migration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_live_migration_request_view.serialize(body, content_type)
...
class CreatePushMigration(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_push_migration(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_push_migration(
        ...
        return self._create_push_migration_oapg(
            body=body,
