...
class LogNameSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "mongodb": "MONGODB",
            "mongos": "MONGOS",
            "mongodb-audit-log": "MONGODBAUDITLOG",
            "mongos-audit-log": "MONGOSAUDITLOG",
        }
    ...
    @schemas.classproperty
    def MONGODBAUDITLOG(cls):
        return cls("mongodb-audit-log")
    
    @schemas.classproperty
    def MONGOSAUDITLOG(cls):
        return cls("mongos-audit-log")
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'groupId': typing.Union[GroupIdSchema, str, ],
        'hostName': typing.Union[HostNameSchema, str, ],
        'logName': typing.Union[LogNameSchema, str, ],
    }
)
...
request_path_host_name = api_client.PathParameter(
    name="hostName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=HostNameSchema,
    required=True,
)
request_path_log_name = api_client.PathParameter(
    name="logName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LogNameSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230201gzip = schemas.BinarySchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-02-01+gzip': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndAtlas20230201gzip),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_host_logs_oapg(
        ...
        for parameter in (
            ...
            request_path_host_name,
            request_path_log_name,
        ):
...
class GetHostLogs(BaseApi):
    ...
    def get_host_logs(
        ...
        return self._get_host_logs_oapg(
