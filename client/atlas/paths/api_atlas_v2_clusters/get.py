...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedOrgGroupView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_clusters_for_all_projects_oapg(
        self,
...
class ListClustersForAllProjects(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_clusters_for_all_projects(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_clusters_for_all_projects(
        ...
        return self._list_clusters_for_all_projects_oapg(
