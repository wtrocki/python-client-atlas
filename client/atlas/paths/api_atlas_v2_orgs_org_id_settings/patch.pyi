...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = OrganizationSettings


request_body_organization_settings = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = OrganizationSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_organization_settings_oapg(
        self,
    ...
    def _update_organization_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_organization_settings.serialize(body, content_type)
...
class UpdateOrganizationSettings(BaseApi):
    ...
    def update_organization_settings(
        ...
        return self._update_organization_settings_oapg(
            body=body,
