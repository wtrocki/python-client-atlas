...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'sampleDatasetId': typing.Union[SampleDatasetIdSchema, str, ],
    }
)
...
request_path_sample_dataset_id = api_client.PathParameter(
    name="sampleDatasetId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SampleDatasetIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = SampleDatasetStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sample_dataset_load_status_oapg(
        self,
    ...
    def _get_sample_dataset_load_status_oapg(
        ...
        for parameter in (
            ...
            request_path_sample_dataset_id,
        ):
...
class GetSampleDatasetLoadStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_sample_dataset_load_status(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_sample_dataset_load_status(
        ...
        return self._get_sample_dataset_load_status_oapg(
