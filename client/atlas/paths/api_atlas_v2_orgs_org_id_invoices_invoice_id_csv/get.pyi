...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.atlas.2023-01-01+csv': api_client.MediaType(),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_invoice_csv_oapg(
        self,
...
class DownloadInvoiceCsv(BaseApi):
    ...
    def download_invoice_csv(
        ...
        return self._download_invoice_csv_oapg(
