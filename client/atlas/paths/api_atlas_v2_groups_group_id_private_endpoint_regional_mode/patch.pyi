...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ProjectSettingItemView


request_body_project_setting_item_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ProjectSettingItemView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _toggle_regionalized_private_endpoint_setting_oapg(
        self,
    ...
    def _toggle_regionalized_private_endpoint_setting_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_setting_item_view.serialize(body, content_type)
...
class ToggleRegionalizedPrivateEndpointSetting(BaseApi):
    ...
    def toggle_regionalized_private_endpoint_setting(
        ...
        return self._toggle_regionalized_private_endpoint_setting_oapg(
            body=body,
