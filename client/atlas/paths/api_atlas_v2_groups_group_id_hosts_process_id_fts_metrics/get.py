...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiFTSMetricsView
...
class ListMetricTypes(BaseApi):
    ...
    def list_metric_types(
        ...
        return self._list_metric_types_oapg(
