...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = IngestionPipeline


request_body_ingestion_pipeline = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_pipeline_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ingestion_pipeline.serialize(body, content_type)
...
class UpdatePipeline(BaseApi):
    ...
    def update_pipeline(
        ...
        return self._update_pipeline_oapg(
            body=body,
