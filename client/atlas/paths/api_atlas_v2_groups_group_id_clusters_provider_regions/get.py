...
request_query_tier = api_client.QueryParameter(
    name="tier",
    style=api_client.ParameterStyle.FORM,
    schema=TierSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiAtlasProviderRegionsView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_cloud_provider_regions_oapg(
        self,
...
class ListCloudProviderRegions(BaseApi):
    ...
    def list_cloud_provider_regions(
        ...
        return self._list_cloud_provider_regions_oapg(
