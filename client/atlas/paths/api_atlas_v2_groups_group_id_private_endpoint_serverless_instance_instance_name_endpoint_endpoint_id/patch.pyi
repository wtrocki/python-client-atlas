...
# body param
SchemaForRequestBodyApplicationJson = ServerlessTenantEndpointUpdate


request_body_serverless_tenant_endpoint_update = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ServerlessTenantEndpoint
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_serverless_private_endpoint_oapg(
        self,
    ...
    def _update_serverless_private_endpoint_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_serverless_tenant_endpoint_update.serialize(body, content_type)
...
class UpdateServerlessPrivateEndpoint(BaseApi):
    ...
    def update_serverless_private_endpoint(
        ...
        return self._update_serverless_private_endpoint_oapg(
            body=body,
