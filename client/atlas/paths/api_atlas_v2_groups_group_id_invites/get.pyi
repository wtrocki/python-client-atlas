...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ApiGroupInvitationView']:
            return ApiGroupInvitationView

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ApiGroupInvitationView'], typing.List['ApiGroupInvitationView']],
    ...
    def __getitem__(self, i: int) -> 'ApiGroupInvitationView':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_project_invitations_oapg(
        self,
...
class ListProjectInvitations(BaseApi):
    ...
    def list_project_invitations(
        ...
        return self._list_project_invitations_oapg(
