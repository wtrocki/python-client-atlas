...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ApiGroupInvitationRequestView


request_body_api_group_invitation_request_view = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_project_invitation_oapg(
        self,
    ...
    def _update_project_invitation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_api_group_invitation_request_view.serialize(body, content_type)
...
class UpdateProjectInvitation(BaseApi):
    ...
    def update_project_invitation(
        ...
        return self._update_project_invitation_oapg(
            body=body,
