...
class LimitNameSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "bytesProcessed.query": "QUERY",
            "bytesProcessed.daily": "DAILY",
            "bytesProcessed.weekly": "WEEKLY",
            "bytesProcessed.monthly": "MONTHLY",
        }
    
    @schemas.classproperty
    def QUERY(cls):
        return cls("bytesProcessed.query")
    
    @schemas.classproperty
    def DAILY(cls):
        return cls("bytesProcessed.daily")
    
    @schemas.classproperty
    def WEEKLY(cls):
        return cls("bytesProcessed.weekly")
    
    @schemas.classproperty
    def MONTHLY(cls):
        return cls("bytesProcessed.monthly")
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'groupId': typing.Union[GroupIdSchema, str, ],
        'tenantName': typing.Union[TenantNameSchema, str, ],
...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DataFederationTenantQueryLimit


request_body_data_federation_tenant_query_limit = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationVndAtlas20230101json(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DataFederationTenantQueryLimit']:
            return DataFederationTenantQueryLimit

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DataFederationTenantQueryLimit'], typing.List['DataFederationTenantQueryLimit']],
    ...
    def __getitem__(self, i: int) -> 'DataFederationTenantQueryLimit':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_one_data_federation_query_limit_oapg(
        self,
    ...
    def _create_one_data_federation_query_limit_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_data_federation_tenant_query_limit.serialize(body, content_type)
...
class CreateOneDataFederationQueryLimit(BaseApi):
    ...
    def create_one_data_federation_query_limit(
        ...
        return self._create_one_data_federation_query_limit_oapg(
            body=body,
