...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = CloudProviderAccessRole


request_body_cloud_provider_access_role = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = CloudProviderAccessRole
...
class BaseApi(api_client.Api):
    @typing.overload
    def _authorize_cloud_provider_access_role_oapg(
        self,
    ...
    def _authorize_cloud_provider_access_role_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cloud_provider_access_role.serialize(body, content_type)
...
class AuthorizeCloudProviderAccessRole(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def authorize_cloud_provider_access_role(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def authorize_cloud_provider_access_role(
        ...
        return self._authorize_cloud_provider_access_role_oapg(
            body=body,
