...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = ApiDiskPartitionView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_disk_measurements_oapg(
        self,
...
class ListDiskMeasurements(BaseApi):
    ...
    def list_disk_measurements(
        ...
        return self._list_disk_measurements_oapg(
