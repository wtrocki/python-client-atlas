...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'completed': typing.Union[CompletedSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedSnapshotView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_legacy_snapshots_oapg(
        self,
...
class ListLegacySnapshots(BaseApi):
    ...
    def list_legacy_snapshots(
        ...
        return self._list_legacy_snapshots_oapg(
