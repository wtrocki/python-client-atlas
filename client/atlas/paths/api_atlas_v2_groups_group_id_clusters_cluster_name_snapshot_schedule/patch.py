...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = SnapshotSchedule


request_body_snapshot_schedule = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = SnapshotSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_legacy_snapshot_schedule_oapg(
        self,
    ...
    def _update_legacy_snapshot_schedule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_snapshot_schedule.serialize(body, content_type)
...
class UpdateLegacySnapshotSchedule(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_legacy_snapshot_schedule(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_legacy_snapshot_schedule(
        ...
        return self._update_legacy_snapshot_schedule_oapg(
            body=body,
