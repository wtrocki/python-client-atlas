...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiAtlasCheckpointView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_legacy_backup_checkpoints_oapg(
        self,
...
class ListLegacyBackupCheckpoints(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_legacy_backup_checkpoints(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_legacy_backup_checkpoints(
        ...
        return self._list_legacy_backup_checkpoints_oapg(
