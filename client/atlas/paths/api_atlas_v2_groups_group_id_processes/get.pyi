...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedHostViewAtlas
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_atlas_processes_oapg(
        self,
...
class ListAtlasProcesses(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_atlas_processes(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_atlas_processes(
        ...
        return self._list_atlas_processes_oapg(
