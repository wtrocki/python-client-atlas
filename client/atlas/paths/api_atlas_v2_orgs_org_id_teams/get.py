...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedTeamView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_organization_teams_oapg(
        self,
...
class ListOrganizationTeams(BaseApi):
    ...
    def list_organization_teams(
        ...
        return self._list_organization_teams_oapg(
