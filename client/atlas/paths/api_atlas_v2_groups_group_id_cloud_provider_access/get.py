...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = CloudProviderAccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_cloud_provider_access_roles_oapg(
        self,
...
class ListCloudProviderAccessRoles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_cloud_provider_access_roles(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_cloud_provider_access_roles(
        ...
        return self._list_cloud_provider_access_roles_oapg(
