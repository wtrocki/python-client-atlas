...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = DiskBackupSnapshotSchedule


request_body_disk_backup_snapshot_schedule = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = DiskBackupSnapshotSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_backup_schedule_oapg(
        self,
    ...
    def _update_backup_schedule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_disk_backup_snapshot_schedule.serialize(body, content_type)
...
class UpdateBackupSchedule(BaseApi):
    ...
    def update_backup_schedule(
        ...
        return self._update_backup_schedule_oapg(
            body=body,
