...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiAtlasServerlessBackupSnapshotView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_serverless_backups_oapg(
        self,
...
class ListServerlessBackups(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_serverless_backups(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_serverless_backups(
        ...
        return self._list_serverless_backups_oapg(
