...
class EntryValueSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^([0-9]{1,3}\.){3}[0-9]{1,3}(%2[fF][0-9]{1,3})?|([0-9a-f]{1,4}\:){7}[0-9a-f]{1,4}(%2[fF][0-9]{1,3})?|([0-9a-f]{1,4}\:){1,6}\:(%2[fF][0-9]{1,3})|(sg\-[a-f0-9]{8})?$',  # noqa: E501
        }]
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'groupId': typing.Union[GroupIdSchema, str, ],
        'entryValue': typing.Union[EntryValueSchema, str, ],
    }
)
...
request_path_entry_value = api_client.PathParameter(
    name="entryValue",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EntryValueSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = NetworkPermissionEntryStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_ip_access_list_status_oapg(
        self,
...
class GetProjectIpAccessListStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_project_ip_access_list_status(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_project_ip_access_list_status(
        ...
        return self._get_project_ip_access_list_status_oapg(
