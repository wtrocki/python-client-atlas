...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = CloudProviderContainer


request_body_cloud_provider_container = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = CloudProviderContainer
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_peering_container_oapg(
        self,
    ...
    def _update_peering_container_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cloud_provider_container.serialize(body, content_type)
...
class UpdatePeeringContainer(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_peering_container(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndAtlas20230101json,],
        content_type: typing_extensions.Literal["application/vnd.atlas.2023-01-01+json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_peering_container(
        ...
        return self._update_peering_container_oapg(
            body=body,
