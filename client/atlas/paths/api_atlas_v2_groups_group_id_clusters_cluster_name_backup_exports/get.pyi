...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedApiAtlasDiskBackupExportJobView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_backup_export_jobs_oapg(
        self,
...
class ListBackupExportJobs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_backup_export_jobs(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_backup_export_jobs(
        ...
        return self._list_backup_export_jobs_oapg(
