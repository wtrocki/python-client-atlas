...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'createdBefore': typing.Union[CreatedBeforeSchema, str, datetime, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedPipelineRunView
...
class ListPipelineRuns(BaseApi):
    ...
    def list_pipeline_runs(
        ...
        return self._list_pipeline_runs_oapg(
