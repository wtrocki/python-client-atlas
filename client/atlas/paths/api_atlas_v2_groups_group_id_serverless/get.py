...
SchemaFor200ResponseBodyApplicationVndAtlas20230101json = PaginatedServerlessInstanceDescriptionView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_serverless_instances_oapg(
        self,
...
class ListServerlessInstances(BaseApi):
    ...
    def list_serverless_instances(
        ...
        return self._list_serverless_instances_oapg(
