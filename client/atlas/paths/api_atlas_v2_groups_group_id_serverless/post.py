...
# body param
SchemaForRequestBodyApplicationVndAtlas20230101json = ServerlessInstanceDescriptionCreate


request_body_serverless_instance_description_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndAtlas20230101json = ServerlessInstanceDescription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_serverless_instance_oapg(
        self,
    ...
    def _create_serverless_instance_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_serverless_instance_description_create.serialize(body, content_type)
...
class CreateServerlessInstance(BaseApi):
    ...
    def create_serverless_instance(
        ...
        return self._create_serverless_instance_oapg(
            body=body,
