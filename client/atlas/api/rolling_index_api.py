...
class RollingIndexApi(object):
    ...
    @validate_arguments
    def create_rolling_index(self, group_id : Annotated[constr(strict=True, max_length=24, min_length=24), Field(..., description="Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.  **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.")], cluster_name : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="Human-readable label that identifies the cluster on which MongoDB Cloud creates an index.")], api_index_request_view : Annotated[ApiIndexRequestView, Field(..., description="Rolling index to create on the specified cluster.")], envelope : Annotated[Optional[StrictBool], Field(description="Flag that indicates whether Application wraps the response in an `envelope` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.")] = None, pretty : Annotated[Optional[StrictBool], Field(description="Flag that indicates whether the response body should be in the <a href=\"https://en.wikipedia.org/wiki/Prettyprint\" target=\"_blank\" rel=\"noopener noreferrer\">prettyprint</a> format.")] = None, **kwargs) -> None:  # noqa: E501
        """Create One Rolling Index  # noqa: E501
        ...
        >>> thread = api.create_rolling_index(group_id, cluster_name, api_index_request_view, envelope, pretty, async_req=True)
        >>> result = thread.get()

        :param group_id: Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.  **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups. (required)
        :type group_id: str
        :param cluster_name: Human-readable label that identifies the cluster on which MongoDB Cloud creates an index. (required)
        :type cluster_name: str
        :param api_index_request_view: Rolling index to create on the specified cluster. (required)
        :type api_index_request_view: ApiIndexRequestView
        ...
        return self.create_rolling_index_with_http_info(group_id, cluster_name, api_index_request_view, envelope, pretty, **kwargs)  # noqa: E501

    @validate_arguments
    def create_rolling_index_with_http_info(self, group_id : Annotated[constr(strict=True, max_length=24, min_length=24), Field(..., description="Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.  **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.")], cluster_name : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="Human-readable label that identifies the cluster on which MongoDB Cloud creates an index.")], api_index_request_view : Annotated[ApiIndexRequestView, Field(..., description="Rolling index to create on the specified cluster.")], envelope : Annotated[Optional[StrictBool], Field(description="Flag that indicates whether Application wraps the response in an `envelope` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.")] = None, pretty : Annotated[Optional[StrictBool], Field(description="Flag that indicates whether the response body should be in the <a href=\"https://en.wikipedia.org/wiki/Prettyprint\" target=\"_blank\" rel=\"noopener noreferrer\">prettyprint</a> format.")] = None, **kwargs):  # noqa: E501
        """Create One Rolling Index  # noqa: E501
        ...
        >>> thread = api.create_rolling_index_with_http_info(group_id, cluster_name, api_index_request_view, envelope, pretty, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_rolling_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['api_index_request_view']:
            _body_params = _params['api_index_request_view']
        ...
        return self.api_client.call_api(
            '/api/atlas/v2/groups/{groupId}/clusters/{clusterName}/index', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
