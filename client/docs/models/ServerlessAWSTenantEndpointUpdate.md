# atlas.model.serverless_aws_tenant_endpoint_update.ServerlessAWSTenantEndpointUpdate
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Updates to a serverless AWS tenant endpoint. | 
