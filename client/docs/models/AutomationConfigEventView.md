# atlas.model.automation_config_event_view.AutomationConfigEventView
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Automation config event identifies that deployment configuration is published. | 
...
**eventTypeName** | [**AutomationConfigEventTypeView**](AutomationConfigEventTypeView.md) | [**AutomationConfigEventTypeView**](AutomationConfigEventTypeView.md) |  | 
