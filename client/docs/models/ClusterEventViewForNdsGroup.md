# atlas.model.cluster_event_view_for_nds_group.ClusterEventViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Cluster event identifies different activities about cluster of mongod hosts. | 
...
**eventTypeName** | [**ClusterEventTypeViewForNdsGroup**](ClusterEventTypeViewForNdsGroup.md) | [**ClusterEventTypeViewForNdsGroup**](ClusterEventTypeViewForNdsGroup.md) |  | 
