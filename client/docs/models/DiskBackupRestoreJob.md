# atlas.model.disk_backup_restore_job.DiskBackupRestoreJob
...
**[components](#components)** | list, tuple,  | tuple,  | Information on the restore job for each replica set in the sharded cluster. | [optional] 
