# atlas.model.nds_auto_scaling_audit_view_for_nds_group.NDSAutoScalingAuditViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | NDS auto scaling audit indicates when atlas auto-scaling cluster tier up or down. | 
...
**eventTypeName** | [**NDSAutoScalingAuditTypeViewForNdsGroup**](NDSAutoScalingAuditTypeViewForNdsGroup.md) | [**NDSAutoScalingAuditTypeViewForNdsGroup**](NDSAutoScalingAuditTypeViewForNdsGroup.md) |  | 
