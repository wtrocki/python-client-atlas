# atlas.model.replica_set_alert_config_view_for_nds_group.ReplicaSetAlertConfigViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Replica Set alert configuration allows to select which conditions of mongod replica set trigger alerts and how users are notified. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**eventTypeName** | [**ReplicaSetEventTypeViewForNdsGroupAlertableNoThreshold**](ReplicaSetEventTypeViewForNdsGroupAlertableNoThreshold.md) | [**ReplicaSetEventTypeViewForNdsGroupAlertableNoThreshold**](ReplicaSetEventTypeViewForNdsGroupAlertableNoThreshold.md) |  | 
...
**threshold** | [**ThresholdViewInteger**](ThresholdViewInteger.md) | [**ThresholdViewInteger**](ThresholdViewInteger.md) |  | [optional] 
