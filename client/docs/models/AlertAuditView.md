# atlas.model.alert_audit_view.AlertAuditView

Alert audit indicates acknowledgement status of an alert.

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Alert audit indicates acknowledgement status of an alert. | 
...
**eventTypeName** | [**AlertAuditTypeView**](AlertAuditTypeView.md) | [**AlertAuditTypeView**](AlertAuditTypeView.md) |  | 
