# atlas.model.org_event_view_for_org.OrgEventViewForOrg

Org event identifies different activities and changes in an organization settings.

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Org event identifies different activities and changes in an organization settings. | 
...
**eventTypeName** | [**OrgEventTypeViewForOrg**](OrgEventTypeViewForOrg.md) | [**OrgEventTypeViewForOrg**](OrgEventTypeViewForOrg.md) |  | 
