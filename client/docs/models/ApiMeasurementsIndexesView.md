# atlas.model.api_measurements_indexes_view.ApiMeasurementsIndexesView
...
------------ | ------------- | ------------- | ------------- | -------------
**collectionName** | str,  | str,  | Human-readable label that identifies the collection. | [optional] 
...
**[indexIds](#indexIds)** | list, tuple,  | tuple,  | List that contains the Atlas Search index identifiers. | [optional] 
**[indexStatsMeasurements](#indexStatsMeasurements)** | list, tuple,  | tuple,  | List that contains the Atlas Search index stats measurements. | [optional] 
