# atlas.model.create_azure_endpoint_request.CreateAzureEndpointRequest
...
------------ | ------------- | ------------- | ------------- | -------------
**id** | str,  | str,  | Unique string that identifies the private endpoint&#x27;s network interface that someone added to this private endpoint service. | [optional] 
