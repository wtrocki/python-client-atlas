# atlas.model.api_group_invitation_request_view.ApiGroupInvitationRequestView
...
**username** | str,  | str,  | Email address of the MongoDB Cloud user invited to the specified project. | [optional] 
