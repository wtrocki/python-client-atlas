# atlas.model.serverless_metric_alert_config_view_for_nds_group.ServerlessMetricAlertConfigViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Serverless metric alert configuration allows to select which serverless database metrics trigger alerts and how users are notified. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**eventTypeName** | [**ServerlessEventTypeViewAlertable**](ServerlessEventTypeViewAlertable.md) | [**ServerlessEventTypeViewAlertable**](ServerlessEventTypeViewAlertable.md) |  | 
...
**metricThreshold** | [**ServerlessMetricThresholdView**](ServerlessMetricThresholdView.md) | [**ServerlessMetricThresholdView**](ServerlessMetricThresholdView.md) |  | [optional] 
