# atlas.model.nds_tenant_endpoint_audit_view.NDSTenantEndpointAuditView

NDS tenant endpoint audit indicates when atlas auto-scaling cluster tier up or down.

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | NDS tenant endpoint audit indicates when atlas auto-scaling cluster tier up or down. | 
...
**eventTypeName** | [**NDSTenantEndpointAuditTypeView**](NDSTenantEndpointAuditTypeView.md) | [**NDSTenantEndpointAuditTypeView**](NDSTenantEndpointAuditTypeView.md) |  | 
