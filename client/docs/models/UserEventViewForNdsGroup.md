# atlas.model.user_event_view_for_nds_group.UserEventViewForNdsGroup

User event reflects different activities about the atlas user.

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | User event reflects different activities about the atlas user. | 
...
**eventTypeName** | [**UserEventTypeViewForNdsGroup**](UserEventTypeViewForNdsGroup.md) | [**UserEventTypeViewForNdsGroup**](UserEventTypeViewForNdsGroup.md) |  | 
