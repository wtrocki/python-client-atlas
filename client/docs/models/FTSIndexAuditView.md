# atlas.model.fts_index_audit_view.FTSIndexAuditView

FTS index audit indicates any activities about search index.

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | FTS index audit indicates any activities about search index. | 
...
**eventTypeName** | [**FTSIndexAuditTypeView**](FTSIndexAuditTypeView.md) | [**FTSIndexAuditTypeView**](FTSIndexAuditTypeView.md) |  | 
