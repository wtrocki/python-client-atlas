# atlas.model.host_alert_view_for_nds_group.HostAlertViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Host alert notifies about activities on mongod host. | 
