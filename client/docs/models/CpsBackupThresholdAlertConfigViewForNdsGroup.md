# atlas.model.cps_backup_threshold_alert_config_view_for_nds_group.CpsBackupThresholdAlertConfigViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Cps Backup threshold alert configuration allows to select thresholds for conditions of CPS backup or oplogs anomalies which trigger alerts and how users are notified. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**eventTypeName** | [**CpsBackupEventTypeViewForNdsGroupAlertableWithThreshold**](CpsBackupEventTypeViewForNdsGroupAlertableWithThreshold.md) | [**CpsBackupEventTypeViewForNdsGroupAlertableWithThreshold**](CpsBackupEventTypeViewForNdsGroupAlertableWithThreshold.md) |  | 
...
**threshold** | [**GreaterThanTimeThresholdView**](GreaterThanTimeThresholdView.md) | [**GreaterThanTimeThresholdView**](GreaterThanTimeThresholdView.md) |  | [optional] 
