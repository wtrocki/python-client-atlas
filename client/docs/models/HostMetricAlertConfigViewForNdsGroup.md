# atlas.model.host_metric_alert_config_view_for_nds_group.HostMetricAlertConfigViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Host metric alert configuration allows to select which mongod host metrics trigger alerts and how users are notified. | 
...
**metricThreshold** | [**HostMetricThresholdView**](HostMetricThresholdView.md) | [**HostMetricThresholdView**](HostMetricThresholdView.md) |  | [optional] 
