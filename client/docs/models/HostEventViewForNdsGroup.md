# atlas.model.host_event_view_for_nds_group.HostEventViewForNdsGroup

Host event identifies different activities about mongod host.

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Host event identifies different activities about mongod host. | 
...
**eventTypeName** | [**HostEventTypeViewForNdsGroup**](HostEventTypeViewForNdsGroup.md) | [**HostEventTypeViewForNdsGroup**](HostEventTypeViewForNdsGroup.md) |  | 
