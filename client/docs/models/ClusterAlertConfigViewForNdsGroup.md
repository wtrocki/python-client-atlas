# atlas.model.cluster_alert_config_view_for_nds_group.ClusterAlertConfigViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Cluster alert configuration allows to select which conditions of mongod cluster which trigger alerts and how users are notified. | 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**ClusterMatcherView**](ClusterMatcherView.md) | [**ClusterMatcherView**](ClusterMatcherView.md) | [**ClusterMatcherView**](ClusterMatcherView.md) |  | 
