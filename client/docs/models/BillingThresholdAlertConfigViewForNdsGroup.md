# atlas.model.billing_threshold_alert_config_view_for_nds_group.BillingThresholdAlertConfigViewForNdsGroup
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Billing threshold alert configuration allows to select thresholds for bills and invoices which trigger alerts and how users are notified. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**eventTypeName** | [**BillingEventTypeViewAlertableWithThreshold**](BillingEventTypeViewAlertableWithThreshold.md) | [**BillingEventTypeViewAlertableWithThreshold**](BillingEventTypeViewAlertableWithThreshold.md) |  | 
...
**threshold** | [**GreaterThanRawThresholdView**](GreaterThanRawThresholdView.md) | [**GreaterThanRawThresholdView**](GreaterThanRawThresholdView.md) |  | [optional] 
